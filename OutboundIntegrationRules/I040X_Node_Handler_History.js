...
{
  "id" : "I040X_Node_Handler_History",
  "type" : "BusinessAction",
  "setupGroups" : [ "Outbound_Integration_Rules" ],
  "name" : "I040X Node Handler History",
  "description" : null,
  "scope" : "Global",
  "validObjectTypes" : [ ],
...
if (node != null && node instanceof com.stibo.core.domain.Product) {
  ...
  if (nodeHandlerSource.isDeleted()) {
	...
	var values2 =utilityLib.getReferencedByToValuesAsJSON(node, "Journal_History_Reference", true, null, stepManager);
	var values={};
	...
	mesg.referencedby=utilityLib.getReferencedByToValuesAsJSONHistory(node, "Journal_History_Reference", true, null, stepManager);
	mesg.references=utilityLib.getReferencesAsJSON(node, "HISTORY_TO_HISTORY_TRANSITION", true, null, stepManager);
//	mesg.references=utilityLib.getReferencesAsJSON(node, referenceTypesToInclude, true, null, stepManager);
