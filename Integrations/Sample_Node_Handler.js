...
{
  "id" : "Sample_Node_Handler",
  "type" : "BusinessAction",
  "setupGroups" : [ "Integrations" ],
  "name" : "JSON_Node_Handler",
  "description" : null,
  "scope" : "Global",
  "validObjectTypes" : [ ],
...
*/
exports.operation0 = function (nodeHandlerSource,nodeHandlerResult,executionReportLogger,utilityLib) {
...
if (node != null && node instanceof com.stibo.core.domain.Product) {
  ...
  if (nodeHandlerSource.isDeleted()) {
	...
	mesg.references=utilityLib.getReferencesAsJSON(node, [], true);
...
function getChildObjects(inputNode){	
	var childObjects = [];
	...
	while(childObjectsIter.hasNext())
	{
		...
		childObjectArray.mediaObject = utilityLib.initialNodeJSON(childObjectNode);
		childObjectArray.mediaObject.values = utilityLib.getAllValuesAsJSON(childObjectNode);		
