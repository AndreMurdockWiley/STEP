...
{
  "id" : "I0401_Node_Handler_JournalNetwork",
  "type" : "BusinessAction",
  "setupGroups" : [ "Outbound_Integration_Rules" ],
  "name" : "I0401_Node_Handler_JournalNetwork",
  "description" : null,
  "scope" : "Global",
  "validObjectTypes" : [ ],
...
/*===== business rule plugin definition =====
{
  ...
  "binds" : [ {
    ...
    "alias" : "journalNetworkToJournals",
    "parameterClass" : "com.stibo.core.domain.impl.ReferenceTypeImpl",
    "value" : "JournalNetworkToJournals",
    "description" : null
  } ],
  "messages" : [ ],
...
*/
exports.operation0 = function (nodeHandlerSource,nodeHandlerResult,executionReportLogger,manager,journalNetworkToJournals,utilityLib) {
...
if (node != null && node instanceof com.stibo.core.domain.Product) {
  ...
  if (nodeHandlerSource.isDeleted()) {
    nodeHandlerResult.addMessage("deletes", JSON.stringify(mesg));	
  	...
  	var mesg = utilityLib.initialNodeJSONJournalNetwork(node,manager);	
	...
	mesg.references=utilityLib.getReferencesJournalNetworkAsJSON(node,journalNetworkToJournals, true, null, manager);
