...
Journals Mass Update Validate Text Fields. It primarily works with attribute(s): JournalBackfileContentISSN, JournalMarketingCopyHeadline, JournalMarketingCopySubjectArea, JournalMarketingCopyUSP1, JournalMarketingCopyUSP2, JournalMarketingCopyUSP3, JournalMarketingCopyUSP4. It is triggered from: Business condition (validation configured in STEP). If validation fails, the user sees an error message such as: "<b>Please correct the Fields : </b>{errormessage}".
