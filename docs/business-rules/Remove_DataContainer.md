...
Remove_DataContainer. It primarily works with attribute(s): JournalMarketingInitiativesDataContainer. It is triggered from: Business action (triggered via Web UI button / workflow event / configured action).
