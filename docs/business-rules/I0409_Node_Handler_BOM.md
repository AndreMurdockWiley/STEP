## I0409_Node_Handler_BOM

- **Rule type**: Business Action
- **Business area**: Outbound_Integration_Rules
- **Data model object valid to**: All
- **Source file(s)**: `Integrations/OutboundIntegrationRules/I0409_Node_Handler_BOM.js`, `OutboundIntegrationRules/I0409_Node_Handler_BOM.js`

### Functional description

I0409_Node_Handler_BOM. It is triggered from: Integration rule (configured in STEP Integration Endpoints). If validation fails, the user sees an error message such as: "N/A (Business Action).".
...
- **Row(s) (0-based in data block)**: 300, 363
