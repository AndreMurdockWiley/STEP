...
WebUI_Update_DOI_URL. It primarily works with attribute(s): COPY_DOI, COPY_URL, ProductBundleCodeID, ProductDoi, ProductIsbn13, ProductUrl. If validation fails, the user sees an error message such as: "N/A (Business Action).".
