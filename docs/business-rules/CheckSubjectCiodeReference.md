## CheckSubjectCiodeReference

- **Rule type**: Business Condition
- **Business area**: Conditions
- **Data model object valid to**: All
- **Source file(s)**: `Conditions/CheckSubjectCiodeReference.js`

### Functional description

Check Subject Ciode Reference. It is triggered from: Business condition (validation configured in STEP).
...
- **Row(s) (0-based in data block)**: 237
