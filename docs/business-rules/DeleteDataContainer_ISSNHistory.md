...
Delete Data Container ISSN History. It primarily works with attribute(s): ISSNHistory_DataContainer. It is triggered from: Business action (triggered via Web UI button / workflow event / configured action).
