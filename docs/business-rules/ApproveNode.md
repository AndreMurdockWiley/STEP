...
- **Source file(s)**: `Actions/ApproveNode.js`

### Functional description

Used  Approve the Current Node. It is triggered from: Business action (triggered via Web UI button / workflow event / configured action).
...
- **Row(s) (0-based in data block)**: 196
