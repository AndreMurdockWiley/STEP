...
Create Journals Transition. It primarily works with attribute(s): JournalGroupCode, JournalProductCode, JournalProductionCode, JournalOnlineLibraryCode, JournalInCurrentDatabaseModel.
