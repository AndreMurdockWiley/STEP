## Journals_Completed_Transition_2
...
- **Version**: 1
- **Status**: Active
- **Source file(s)**: `JournalWorkflowGroup/Journals_Completed_Transition_2.js`

### Functional description

Journals Completed Transition(2). If validation fails, the user sees an error message such as: "N/A (Business Action).".
...
- **Dependencies**: References 7 other business actions
...
- **Row(s) (0-based in data block)**: 25
