...
- **Status**: Active
- **Source file(s)**: `Actions/Delete.js`

### Functional description

Delete. It is triggered from: Business action (triggered via Web UI / workflow event). If validation fails, the user sees an error message such as: "N/A (Business Action).".
...
- **Row(s) (0-based in data block)**: 84
