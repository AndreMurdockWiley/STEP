...
- **Source file(s)**: `JournalMediaGroup/JournalMediaWorkflowGroup/JournalMediaSaveAction.js`

### Functional description

Journal Media Save Action. If validation fails, the user sees an error message such as: "N/A (Business Action).".
...
- **Row(s) (0-based in data block)**: 330
