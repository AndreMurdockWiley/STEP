...
Copy Issn To Data Container. It primarily works with attribute(s): ISSNHistory_DataContainer, JournalIssnHistory, ProductIssn. It is triggered from: Business action (triggered via Web UI button / workflow event / configured action).
