...
Test Trigger Rule Create. See the Functional Logic and Usage sections below for the specific configuration and trigger context.
...
Usage information was not provided in the inventory workbook for this rule. A trigger location could not be inferred automatically; review STEP configuration for the source file(s): Integrations/Test_Trigger_Rule.js.
