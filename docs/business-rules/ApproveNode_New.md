...
- **Source file(s)**: `Actions/ApproveNode_New.js`

### Functional description

Used to Delete and Approve the Deletion of the current Node. It is triggered from: Business action (triggered via Web UI button / workflow event / configured action).
...
- **Row(s) (0-based in data block)**: 197
