...
DEPLOYMENT_CHANGEPARENT. It primarily works with attribute(s): JournalGroupCode. It is triggered from: Business action (triggered via Web UI button / workflow event / configured action).
