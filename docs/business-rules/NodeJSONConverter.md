...
NodeJSONConverter. It primarily works with attribute(s): Color, ManufacturerName. It is triggered from: Business action (triggered via Web UI button / workflow event / configured action).
