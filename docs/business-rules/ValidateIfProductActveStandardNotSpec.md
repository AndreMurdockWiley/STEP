...
Validate If Product Activated/Standard/NotSpecific. It primarily works with attribute(s): CollectionSubType, CollectionType, ProductActivated. It is triggered from: Business condition (validation configured in STEP).
