...
Journal Status Derivation. It primarily works with attribute(s): DisplayDigitalMediaStatus, DisplayPrintMediaStatus, JournalAcceptingSubmission, JournalStatus.
