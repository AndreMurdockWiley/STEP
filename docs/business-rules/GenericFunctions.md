...
Generic Functions. It primarily works with attribute(s): JournalGroupCode, JournalMediaNumberOfVolumes, JournalNumberOfVolumes, JournalPublicationYear. If validation fails, the user sees an error message such as: "Invalid ISSN - Expecting".
