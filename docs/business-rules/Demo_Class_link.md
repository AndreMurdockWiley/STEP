...
- **Source file(s)**: `Actions/Demo_Class_link.js`

### Functional description

Demo_Class_link. It is triggered from: Business action (triggered via Web UI / workflow event). If validation fails, the user sees an error message such as: "N/A (Business Action).".
...
- **Row(s) (0-based in data block)**: 213
