...
OIEP_Monitoring_2. It primarily works with attribute(s): ActiveBGP. It is triggered from: Business action (triggered via Web UI button / workflow event / configured action). If validation fails, the user sees an error message such as: "failed".
