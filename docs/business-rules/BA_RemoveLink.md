...
- **Source file(s)**: `Actions/BA_RemoveLink.js`

### Functional description

BA_RemoveLink. It is triggered from: Business action (triggered via Web UI button / workflow event / configured action).
...
- **Row(s) (0-based in data block)**: 208
