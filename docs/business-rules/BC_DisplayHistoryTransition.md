...
BC_DisplayHistoryTransition. It primarily works with attribute(s): HistoryOrigin, Journal_History_Relation. It is triggered from: Business condition (validation configured in STEP).
