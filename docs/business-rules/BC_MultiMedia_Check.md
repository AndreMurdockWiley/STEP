...
- **Source file(s)**: `Conditions/BC_MultiMedia_Check.js`

### Functional description

MultiMedia BOM Check. It is triggered from: Business condition (validation configured in STEP).
...
- **Row(s) (0-based in data block)**: 227
