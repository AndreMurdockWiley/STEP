## I0401_Node_Handler_Journals_New

- **Rule type**: Business Action
- **Business area**: Outbound_Integration_Rules
- **Data model object valid to**: All
- **Source file(s)**: `Integrations/OutboundIntegrationRules/I0401_Node_Handler_Journals_New.js`, `OutboundIntegrationRules/I0401_Node_Handler_Journals_New.js`

### Functional description

I0401_Node_Handler_Journals_New. It is triggered from: Integration rule (configured in STEP Integration Endpoints). If validation fails, the user sees an error message such as: "N/A (Business Action).".
...
- **Row(s) (0-based in data block)**: 299, 362
