...
- **Version**: 1
- **Status**: Active
- **Source file(s)**: `Libraries/Generic_Search_Functions.js`

### Functional description

Generic Search Functions. If validation fails, the user sees an error message such as: "N/A (Business Action).".
...
- **Dependencies**: None
- **Key functions**: search_object_using_key()

### Traceability

- **Source workbook**: `Stibo STEP Global Business Rules v1.3.xlsx`
- **Sheet**: `Global Business Rules Template `
- **Row(s) (0-based in data block)**: 9
