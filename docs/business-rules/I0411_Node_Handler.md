...
- **Source file(s)**: `Integrations/OutboundIntegrationRules/I0411_Node_Handler.js`, `OutboundIntegrationRules/I0411_Node_Handler.js`

### Functional description

I0411_Node_Handler_Issues. It is triggered from: Integration rule (configured in STEP Integration Endpoints). If validation fails, the user sees an error message such as: "N/A (Business Action).".
...
- **Row(s) (0-based in data block)**: 305, 368
