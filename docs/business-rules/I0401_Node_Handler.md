...
- **Source file(s)**: `Integrations/OutboundIntegrationRules/I0401_Node_Handler.js`, `OutboundIntegrationRules/I0401_Node_Handler.js`

### Functional description

I0401_Node_Handler_Journals. It is triggered from: Integration rule (configured in STEP Integration Endpoints). If validation fails, the user sees an error message such as: "N/A (Business Action).".
...
- **Row(s) (0-based in data block)**: 298, 361
