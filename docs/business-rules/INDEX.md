...
- [`JournalHistoryAutoCreation`](JournalHistoryAutoCreation.md) — Automatically creates or updates a Journal History record and reference for a Journal (Print/Digital), keeping key identifiers and access type in sync.
