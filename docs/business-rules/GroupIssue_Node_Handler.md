...
GroupIssue Node Handler. It primarily works with attribute(s): AG_Group_Issue_OIEP_Attributes. It is triggered from: Outbound integration rule (configured in STEP Outbound Integration).
