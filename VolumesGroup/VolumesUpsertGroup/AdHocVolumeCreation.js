...
{
  "id" : "AdHocVolumeCreation",
  "type" : "BusinessAction",
  "setupGroups" : [ "VolumesUpsertGroup" ],
  "name" : "Ad Hoc Volume Creation",
  "description" : null,
  "scope" : "Global",
  "validObjectTypes" : [ "JournalPrintPublicationYear", "JournalDigitalPublicationYear" ],
...
*/
exports.operation0 = function (NODE,UI,volumeLibrary) {
var journalMedia = NODE.getParent();
var volume = volumeLibrary.createVolume(NODE, journalMedia.getValue("JournalStartingVolume").getSimpleValue());

UI.showAlert("INFO", volume.getName() + " volume has been created!", "");
...
*/
exports.precondition0 = function (node,manager,IssueType_LOV,volumeLibrary) {
