...
{
  "id" : "BA_ApproveSoftDeleteButton",
  "type" : "BusinessAction",
  "setupGroups" : [ "Actions" ],
  "name" : "Approve Soft Delete Button",
  "description" : null,
  "scope" : "Global",
...
if(wfInst)
{
	...
	if(task)
	{
		...
		{
			task.triggerByID("Approve","");
			webUI.navigate("homepage",node);
		}
		else
		{
			webUI.showAlert("ERROR","Please set Soft Delete as 'Yes' to approve Soft Delete");
		}
	}
}
}