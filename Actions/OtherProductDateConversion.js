...
{
  "id" : "OtherProductDateConversion",
  "type" : "BusinessAction",
  "setupGroups" : [ "Actions" ],
  "name" : "Other Product Date Conversion",
  "description" : null,
  "scope" : "Global",
  "validObjectTypes" : [ ],
...
var janisDateAttribGroup = manager.getAttributeGroupHome().getAttributeGroupByID('AG_IDL_DATE');
