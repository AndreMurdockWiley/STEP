...
{
  "id" : "Date_Conversion_Media_Import",
  "type" : "BusinessAction",
  "setupGroups" : [ "Actions" ],
  "name" : "Date Conversion Media Import",
  "description" : null,
  "scope" : "Global",
  "validObjectTypes" : [ ],
...
//Janis Date attributes: JanisJanisJournalMediaRebillingEffEndDt
//Rule resets Janis Date values for the STEP Date attributes: JournalMediaRebillingEffectiveEndDate
var janisDateAttribGroup = manager.getAttributeGroupHome().getAttributeGroupByID('AG_JANISMEDIADATEATTRIBUTES');
...
for(var i = 0; i < attributeList.length; i++){
	...
	if(dummyDate != null){
		...
		if(attributeID == "JanisJournalMediaRebillingEffEndDt"){
			node.getValue("JournalMediaRebillingEffectEndDate").setValue(simpleDateFormat.format(pubDateFixed));
		}
		}
	}
}