...
{
  "id" : "AdHocIssueCreation",
  "type" : "BusinessAction",
  "setupGroups" : [ "IssuesUpsertGroup" ],
  "name" : "Ad Hoc Issue Creation",
  "description" : null,
  "scope" : "Global",
...
*/
exports.operation0 = function (NODE,UI,numberOfIssues,issueTypeValueId,continuousNumberingValueId,IssueType_LOV,YESNO_LOV,LOG,pubLibrary,volumeLibrary,journalLibrary,issueLibrary) {
var issueNumber = 0;
var pubSequence = "";
