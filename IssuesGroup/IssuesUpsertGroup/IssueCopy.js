...
*/
exports.operation0 = function (NODE,UI,issueLibrary) {
var issue = UI.getSelection().get(0);
var copiedIssue = issueLibrary.copyIssue(issue);
var severity = "ACKNOWLEDGEMENT";
var headline = "Issue succesfully copied!";
var body = "Issue succesfully copied.";

UI.showAlert(severity, headline, body);

if(copiedIssue.getObjectType().getID() == "JournalPrintIssues"){
	UI.navigate("PrintIssueNodeDetails", copiedIssue);
}
else if(copiedIssue.getObjectType().getID() == "JournalDigitalIssues"){
	UI.navigate("DigitalIssueNodeDetails", copiedIssue);
}
}
/*===== business rule plugin definition =====
{
...
*/
exports.precondition0 = function (node,manager,IssueType_LOV,issueLibrary) {
