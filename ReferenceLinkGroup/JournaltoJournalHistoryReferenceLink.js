...
{
  "id" : "JournaltoJournalHistoryReferenceLink",
  "type" : "BusinessAction",
  "setupGroups" : [ "ReferenceLinkGroup" ],
  "name" : "Journal To Journal History Reference Link",
  "description" : null,
  "scope" : "Global",
  "validObjectTypes" : [ ],
...
//myReference.getValue("Journal_History_Seq").setSimpleValue(node.getValue("JournalHistorySequenceNumber").getSimpleValue());
} catch (e) {
	log.info("Error: " + e);
}
