# Functional Description: Volume Creation/Next Button

## Overview
This document describes the STIBO STEP business rule implemented in `VolumesGroup/VolumesNavegationGroup/VolumeCreationNextButton.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `VolumeCreationNextButton`
...
- **Source file**: `VolumesGroup/VolumesNavegationGroup/VolumeCreationNextButton.js`
