# Functional Description: Volume Delete

## Overview
This document describes the STIBO STEP business rule implemented in `VolumesGroup/VolumesDeleteGroup/VolumeDelete.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `VolumeDelete`
- **Rule type**: `BusinessAction`
- **Setup group(s)**: `VolumesDeleteGroup`
- **Scope**: `Global`
...
- **Operation**: `issueDeleteBR` (BusinessActionBindContract)
...
- **Source file**: `VolumesGroup/VolumesDeleteGroup/VolumeDelete.js`
