# Functional Description: Volume Creation/Finish Button

## Overview
This document describes the STIBO STEP business rule implemented in `VolumesGroup/VolumesNavegationGroup/VolumeCreationFinishButton.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `VolumeCreationFinishButton`
- **Rule type**: `BusinessAction`
- **Setup group(s)**: `VolumesNavegationGroup`
- **Scope**: `Global`
...
- **Source file**: `VolumesGroup/VolumesNavegationGroup/VolumeCreationFinishButton.js`
