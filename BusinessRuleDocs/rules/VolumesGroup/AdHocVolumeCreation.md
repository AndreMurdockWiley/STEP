# Functional Description: Ad Hoc Volume Creation

## Overview
This document describes the STIBO STEP business rule implemented in `VolumesGroup/VolumesUpsertGroup/AdHocVolumeCreation.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `AdHocVolumeCreation`
- **Rule type**: `BusinessAction`
- **Setup group(s)**: `VolumesUpsertGroup`
- **Scope**: `Global`
- **Valid object types**: `JournalPrintPublicationYear`, `JournalDigitalPublicationYear`
...
- **Source file**: `VolumesGroup/VolumesUpsertGroup/AdHocVolumeCreation.js`
