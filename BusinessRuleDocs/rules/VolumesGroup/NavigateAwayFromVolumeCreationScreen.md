# Functional Description: Navigate Away From Volume Creation Screen
...
## Context
- **Rule ID**: `NavigateAwayFromVolumeCreationScreen`
...
- **Source file**: `VolumesGroup/VolumesNavegationGroup/NavigateAwayFromVolumeCreationScreen.js`
