# Functional Description: Target Search Function for Journal Objects

## Overview
This document describes the STIBO STEP business rule implemented in `Functions/BF_TargetSearchFunctionForJournalObjects.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `BF_TargetSearchFunctionForJournalObjects`
...
- **Source file**: `Functions/BF_TargetSearchFunctionForJournalObjects.js`
