# Functional Description: Default Media Web UI Tab

## Overview
This document describes the STIBO STEP business rule implemented in `Functions/DefaultMediaWebUITab.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
- **Source file**: `Functions/DefaultMediaWebUITab.js`
