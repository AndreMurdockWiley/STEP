# Functional Description: Supplemental Issues Count Test

## Overview
This document describes the STIBO STEP business rule implemented in `Functions/SupplementalIssuesCountTest.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `SupplementalIssuesCountTest`
...
- **Source file**: `Functions/SupplementalIssuesCountTest.js`
