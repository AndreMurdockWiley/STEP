# Functional Description: Target Search Function for Editorial Contact Objects

## Overview
This document describes the STIBO STEP business rule implemented in `Functions/BF_TargetSearchFuncForEditorialContacts.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `BF_TargetSearchFuncForEditorialContacts`
- **Rule type**: `BusinessFunction`
- **Setup group(s)**: `Functions`
- **Scope**: `Global`
...
## Components
### Plugin Definitions
- Operation (JavaScriptBusinessFunctionWithBinds)
...
## Inputs
### Bound Inputs (Binds)
- **Operation**: `step` (ManagerBindContract)
- **Operation**: `email` (AttributeBindContract)
- **Operation**: `editorialCode` (AttributeBindContract)
...
- **Source file**: `Functions/BF_TargetSearchFuncForEditorialContacts.js`
