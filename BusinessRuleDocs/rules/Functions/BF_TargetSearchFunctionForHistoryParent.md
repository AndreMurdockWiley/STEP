# Functional Description: Target Search Function for History Journal Parent Objects

## Overview
This document describes the STIBO STEP business rule implemented in `Functions/BF_TargetSearchFunctionForHistoryParent.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `BF_TargetSearchFunctionForHistoryParent`
...
## Components
### Plugin Definitions
- Operation (QueryBusinessFunction)
...
- **Source file**: `Functions/BF_TargetSearchFunctionForHistoryParent.js`
