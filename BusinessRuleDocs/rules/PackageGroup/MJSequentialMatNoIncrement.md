# Functional Description: MJ Sequential Mat No Increment

## Overview
This document describes the STIBO STEP business rule implemented in `PackageGroup/MJSequentialMatNoIncrement.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `MJSequentialMatNoIncrement`
...
## Key Dependencies
- `journalPackageLibrary`: `JournalPackageFunctions`

## Source Implementation
- **Source file**: `PackageGroup/MJSequentialMatNoIncrement.js`
