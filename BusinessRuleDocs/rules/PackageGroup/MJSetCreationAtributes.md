# Functional Description: MJ Set Creation Atributes

## Overview
This document describes the STIBO STEP business rule implemented in `PackageGroup/MJSetCreationAtributes.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `MJSetCreationAtributes`
...
- **Operation**: `JRNLSTATUS_LOV` (ListOfValuesBindContract)
...
- **Source file**: `PackageGroup/MJSetCreationAtributes.js`
