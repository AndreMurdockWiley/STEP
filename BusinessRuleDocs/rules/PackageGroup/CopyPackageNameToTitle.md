# Functional Description: Copy Package Name To Title

## Overview
This document describes the STIBO STEP business rule implemented in `PackageGroup/CopyPackageNameToTitle.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `CopyPackageNameToTitle`
...
- **Source file**: `PackageGroup/CopyPackageNameToTitle.js`
- **Exports detected**: `operation1`
