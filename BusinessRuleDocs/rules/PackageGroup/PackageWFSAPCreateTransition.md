# Functional Description: MJ Package WF SAP Create Transition

## Overview
This document describes the STIBO STEP business rule implemented in `PackageGroup/PackageWFSAPCreateTransition.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `PackageWFSAPCreateTransition`
...
- **Source file**: `PackageGroup/PackageWFSAPCreateTransition.js`
