# Functional Description: Multi Journal WF Save Button

## Overview
This document describes the STIBO STEP business rule implemented in `PackageGroup/MultiJournalWFSaveButton.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `MultiJournalWFSaveButton`
...
- **Source file**: `PackageGroup/MultiJournalWFSaveButton.js`
