# Functional Description: Multi Journal Effective Date Validate

## Overview
This document describes the STIBO STEP business rule implemented in `PackageGroup/MultiJournalEffectiveDateValidate.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `MultiJournalEffectiveDateValidate`
...
- `MultiJournalFuturePackageStatus`
- `ProductTitle`
...
- **Source file**: `PackageGroup/MultiJournalEffectiveDateValidate.js`
