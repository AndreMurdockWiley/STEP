# Functional Description: Journal Media To Multi Media Link

## Overview
This document describes the STIBO STEP business rule implemented in `PackageGroup/JournalMediaToMultiMediaLink.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `JournalMediaToMultiMediaLink`
...
- **Operation**: `MMrefType` (ReferenceTypeBindContract)
...
- **Source file**: `PackageGroup/JournalMediaToMultiMediaLink.js`
