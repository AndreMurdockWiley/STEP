# Functional Description: MJ Package Valid From Populate

## Overview
This document describes the STIBO STEP business rule implemented in `PackageGroup/MJPackageValidFromPopulate.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `MJPackageValidFromPopulate`
...
- **Operation**: `MJTODIGITAL` (ReferenceTypeBindContract)
- **Operation**: `MJTOPRINT` (ReferenceTypeBindContract)
- **Operation**: `VALIDFROM` (AttributeBindContract)
...
- **Source file**: `PackageGroup/MJPackageValidFromPopulate.js`
