# Functional Description: Pub Year For Copy To Online Creation/Next Button

## Overview
This document describes the STIBO STEP business rule implemented in `PubYearGroup/PubYearNavegationGroup/PubYearForCopyToOnlineCreationNextButton.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `PubYearForCopyToOnlineCreationNextButton`
- **Rule type**: `BusinessAction`
- **Setup group(s)**: `PubYearNavegationGroup`
- **Scope**: `Global`
...
- **Source file**: `PubYearGroup/PubYearNavegationGroup/PubYearForCopyToOnlineCreationNextButton.js`
