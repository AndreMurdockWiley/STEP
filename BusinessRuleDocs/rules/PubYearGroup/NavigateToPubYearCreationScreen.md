# Functional Description: Navigate To Pub Year Creation Screen

## Overview
This document describes the STIBO STEP business rule implemented in `PubYearGroup/PubYearNavegationGroup/NavigateToPubYearCreationScreen.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `NavigateToPubYearCreationScreen`
...
- **Source file**: `PubYearGroup/PubYearNavegationGroup/NavigateToPubYearCreationScreen.js`
