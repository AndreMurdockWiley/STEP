# Functional Description: Automatic Pub Year/Volumes/Issues Creation (EventProcessor)

## Overview
This document describes the STIBO STEP business rule implemented in `PubYearGroup/PubYearUpsertGroup/AutoPubYearVolumesIssuesCreation_Event.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `AutoPubYearVolumesIssuesCreation_Event`
- **Rule type**: `BusinessAction`
- **Setup group(s)**: `PubYearUpsertGroup`
- **Scope**: `Global`
...
- `Copy_Continuous_Number`
- `Copy_Volume_Interval_offset`
- `IssueStatus`
- `IssueType`
- `JournalFinanceProductType`
...
- **Source file**: `PubYearGroup/PubYearUpsertGroup/AutoPubYearVolumesIssuesCreation_Event.js`
