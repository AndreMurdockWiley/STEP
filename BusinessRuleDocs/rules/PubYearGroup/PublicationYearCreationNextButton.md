# Functional Description: Publication Year Creation/Next Button

## Overview
This document describes the STIBO STEP business rule implemented in `PubYearGroup/PubYearNavegationGroup/PublicationYearCreationNextButton.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `PublicationYearCreationNextButton`
...
- **Source file**: `PubYearGroup/PubYearNavegationGroup/PublicationYearCreationNextButton.js`
