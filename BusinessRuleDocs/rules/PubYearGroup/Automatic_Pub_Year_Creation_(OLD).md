# Functional Description: Automatic Pub Year Creation (OLD)

## Overview
This document describes the STIBO STEP business rule implemented in `PubYearGroup/PubYearUpsertGroup/Automatic Pub Year Creation (OLD).js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `Automatic Pub Year Creation (OLD)`
...
## Key Dependencies
- `pubLib`: `PublicationYearUtilityLibrary`

## Source Implementation
- **Source file**: `PubYearGroup/PubYearUpsertGroup/Automatic Pub Year Creation (OLD).js`
