# Functional Description: Navigate Away From Pub Year Creation Screen

## Overview
This document describes the STIBO STEP business rule implemented in `PubYearGroup/PubYearNavegationGroup/NavigateAwayFromPubYearCreation.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `NavigateAwayFromPubYearCreation`
...
- **Source file**: `PubYearGroup/PubYearNavegationGroup/NavigateAwayFromPubYearCreation.js`
