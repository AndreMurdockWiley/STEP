# Functional Description: Publication Year Creation/Finish Button

## Overview
This document describes the STIBO STEP business rule implemented in `PubYearGroup/PubYearNavegationGroup/PublicationYearCreationFinishButton.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `PublicationYearCreationFinishButton`
...
- **Source file**: `PubYearGroup/PubYearNavegationGroup/PublicationYearCreationFinishButton.js`
