# Functional Description: Ad Hoc Publication Year Creation

## Overview
This document describes the STIBO STEP business rule implemented in `PubYearGroup/PubYearUpsertGroup/AdHocPublicationYearCreation.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `AdHocPublicationYearCreation`
...
- **Source file**: `PubYearGroup/PubYearUpsertGroup/AdHocPublicationYearCreation.js`
