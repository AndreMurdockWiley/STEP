# Functional Description: Navigate To Pub Year On-WF Creation Screen

## Overview
This document describes the STIBO STEP business rule implemented in `PubYearGroup/PubYearWorkFlowGroup/NavigateToPubYearOnWFCreationScreen.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `NavigateToPubYearOnWFCreationScreen`
- **Rule type**: `BusinessAction`
- **Setup group(s)**: `PubYearWorkFlowGroup`
- **Scope**: `Global`
...
- **Source file**: `PubYearGroup/PubYearWorkFlowGroup/NavigateToPubYearOnWFCreationScreen.js`
