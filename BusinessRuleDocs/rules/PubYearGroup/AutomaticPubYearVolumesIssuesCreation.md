# Functional Description: Automatic Pub Year/Volumes/Issues Creation

## Overview
This document describes the STIBO STEP business rule implemented in `PubYearGroup/PubYearUpsertGroup/AutomaticPubYearVolumesIssuesCreation.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `AutomaticPubYearVolumesIssuesCreation`
...
- **Operation**: `eventQueuePRODAT` (EventQueueBinding)

### Attributes Referenced (getValue)
- `Copy_Continuous_Number`
- `Copy_Volume_Interval_offset`
- `JournalContinuousNumbering`
- `JournalMergedIssues`
- `JournalVolumeIntervalOffset`
...
- **Source file**: `PubYearGroup/PubYearUpsertGroup/AutomaticPubYearVolumesIssuesCreation.js`
