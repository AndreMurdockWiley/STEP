# Functional Description: Automatic Set Issue Run Date (EventProcessor)

## Overview
This document describes the STIBO STEP business rule implemented in `PubYearGroup/PubYearUpsertGroup/AutoSetIssueRunDate_Event.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `AutoSetIssueRunDate_Event`
...
- **Source file**: `PubYearGroup/PubYearUpsertGroup/AutoSetIssueRunDate_Event.js`
