# Functional Description: Other Product Collection Set Pricing Model

## Overview
This document describes the STIBO STEP business rule implemented in `OtherProductCollectionRules/OtherProductCollectionSetPricingModel.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `OtherProductCollectionSetPricingModel`
...
- `OtherProductCollectionPricingModel`
...
- **Source file**: `OtherProductCollectionRules/OtherProductCollectionSetPricingModel.js`
