# Functional Description: Other Product Collection Save Action

## Overview
This document describes the STIBO STEP business rule implemented in `OtherProductCollectionRules/OtherProductCollectionSaveAction.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `OtherProductCollectionSaveAction`
- **Rule type**: `BusinessAction`
- **Setup group(s)**: `OtherProductCollectionRules`
- **Scope**: `Global`
- **Valid object types**: `OtherProductCollectionOffering`
...
- **Source file**: `OtherProductCollectionRules/OtherProductCollectionSaveAction.js`
