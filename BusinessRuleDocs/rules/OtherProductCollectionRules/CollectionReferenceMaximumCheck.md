# Functional Description: CollectionReferenceMaximumCheck

## Overview
This document describes the STIBO STEP business rule implemented in `OtherProductCollectionRules/CollectionReferenceMaximumCheck.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `CollectionReferenceMaximumCheck`
...
- **Source file**: `OtherProductCollectionRules/CollectionReferenceMaximumCheck.js`
