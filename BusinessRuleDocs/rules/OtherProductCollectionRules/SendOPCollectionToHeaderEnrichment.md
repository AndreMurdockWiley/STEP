# Functional Description: Send OP Collection To Header Enrichment

## Overview
This document describes the STIBO STEP business rule implemented in `OtherProductCollectionRules/SendOPCollectionToHeaderEnrichment.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `SendOPCollectionToHeaderEnrichment`
...
- **Source file**: `OtherProductCollectionRules/SendOPCollectionToHeaderEnrichment.js`
