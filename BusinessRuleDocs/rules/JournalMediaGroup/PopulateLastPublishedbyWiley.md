# Functional Description: Populate Last Published by Wiley

## Overview
This document describes the STIBO STEP business rule implemented in `JournalMediaGroup/JournalMediaWorkflowGroup/PopulateLastPublishedbyWiley.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `PopulateLastPublishedbyWiley`
...
## Inputs
### Bound Inputs (Binds)
- **Operation**: `child` (CurrentObjectBindContract)

### Attributes Referenced (getValue)
- `JournalLastPubYear`
- `LastPublishedbyWiley`
- `ProductStatus`
...
- **Source file**: `JournalMediaGroup/JournalMediaWorkflowGroup/PopulateLastPublishedbyWiley.js`
