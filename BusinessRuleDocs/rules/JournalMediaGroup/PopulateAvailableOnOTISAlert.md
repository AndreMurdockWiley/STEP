# Functional Description: PopulateAvailableOnOTISAlert

## Overview
This document describes the STIBO STEP business rule implemented in `JournalMediaGroup/JournalMediaWorkflowGroup/PopulateAvailableOnOTISAlert.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `PopulateAvailableOnOTISAlert`
...
- **Source file**: `JournalMediaGroup/JournalMediaWorkflowGroup/PopulateAvailableOnOTISAlert.js`
