# Functional Description: Journal Future Print Status Effect Date Validate Send

## Overview
This document describes the STIBO STEP business rule implemented in `JournalMediaGroup/JournalMediaUpsertGroup/JournalFuturePrintDateValidate_Send.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `JournalFuturePrintDateValidate_Send`
...
- `JournalFutureDigitalStatusEffectDate`
- `JournalMediaFuturePrintStatusEffectDate`
...
- **Source file**: `JournalMediaGroup/JournalMediaUpsertGroup/JournalFuturePrintDateValidate_Send.js`
