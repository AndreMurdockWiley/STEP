# Functional Description: Journals_Add_Media_To_Workflow

## Overview
This document describes the STIBO STEP business rule implemented in `JournalMediaGroup/JournalMediaWorkflowGroup/Journals_Add_Media_To_Workflow.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `Journals_Add_Media_To_Workflow`
...
- **Source file**: `JournalMediaGroup/JournalMediaWorkflowGroup/Journals_Add_Media_To_Workflow.js`
