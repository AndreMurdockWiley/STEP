# Functional Description: Journal Future Digital Status Effect Date Validate

## Overview
This document describes the STIBO STEP business rule implemented in `JournalMediaGroup/JournalMediaUpsertGroup/JournalFutureDigitalStatusDateValidate.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `JournalFutureDigitalStatusDateValidate`
...
- `JournalMediaFutureDigitalStatus`
- `ProductStatus`
- `ProductTitle`
...
- **Source file**: `JournalMediaGroup/JournalMediaUpsertGroup/JournalFutureDigitalStatusDateValidate.js`
