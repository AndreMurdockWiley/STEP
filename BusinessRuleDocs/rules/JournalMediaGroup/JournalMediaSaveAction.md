# Functional Description: Journal Media Save Action

## Overview
This document describes the STIBO STEP business rule implemented in `JournalMediaGroup/JournalMediaWorkflowGroup/JournalMediaSaveAction.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `JournalMediaSaveAction`
...
- **Source file**: `JournalMediaGroup/JournalMediaWorkflowGroup/JournalMediaSaveAction.js`
