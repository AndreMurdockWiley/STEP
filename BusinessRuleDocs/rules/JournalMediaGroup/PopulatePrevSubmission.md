# Functional Description: Populate Prev Submission System

## Overview
This document describes the STIBO STEP business rule implemented in `JournalMediaGroup/JournalMediaWorkflowGroup/PopulatePrevSubmission.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `PopulatePrevSubmission`
...
- **Source file**: `JournalMediaGroup/JournalMediaWorkflowGroup/PopulatePrevSubmission.js`
