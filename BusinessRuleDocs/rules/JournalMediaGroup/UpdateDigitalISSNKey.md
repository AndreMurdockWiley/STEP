# Functional Description: Update Digital ISSN Key

## Overview
This document describes the STIBO STEP business rule implemented in `JournalMediaGroup/JournalMediaUpsertGroup/UpdateDigitalISSNKey.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `UpdateDigitalISSNKey`
- **Rule type**: `BusinessAction`
- **Setup group(s)**: `JournalMediaUpsertGroup`
- **Scope**: `Global`
- **Valid object types**: `JournalDigitalMedia`
...
- **Source file**: `JournalMediaGroup/JournalMediaUpsertGroup/UpdateDigitalISSNKey.js`
