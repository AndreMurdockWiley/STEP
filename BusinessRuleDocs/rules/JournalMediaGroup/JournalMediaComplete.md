# Functional Description: Journal Media Complete

## Overview
This document describes the STIBO STEP business rule implemented in `JournalMediaGroup/JournalMediaWorkflowGroup/JournalMediaComplete.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
- **Source file**: `JournalMediaGroup/JournalMediaWorkflowGroup/JournalMediaComplete.js`
