# Functional Description: Populate Journal Media Product Identifier

## Overview
This document describes the STIBO STEP business rule implemented in `JournalMediaGroup/JournalMediaUpsertGroup/PopulateJournalMediaProductIdentifier.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `PopulateJournalMediaProductIdentifier`
...
- **Source file**: `JournalMediaGroup/JournalMediaUpsertGroup/PopulateJournalMediaProductIdentifier.js`
