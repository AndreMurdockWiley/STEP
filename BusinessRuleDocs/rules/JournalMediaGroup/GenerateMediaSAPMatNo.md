# Functional Description: Generate Media SAP Mat No

## Overview
This document describes the STIBO STEP business rule implemented in `JournalMediaGroup/JournalMediaUpsertGroup/GenerateMediaSAPMatNo.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
- **Source file**: `JournalMediaGroup/JournalMediaUpsertGroup/GenerateMediaSAPMatNo.js`
