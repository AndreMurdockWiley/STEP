# Functional Description: Update Print ISSN Key

## Overview
This document describes the STIBO STEP business rule implemented in `JournalMediaGroup/JournalMediaUpsertGroup/UpdatePrintISSNKey.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `UpdatePrintISSNKey`
- **Rule type**: `BusinessAction`
- **Setup group(s)**: `JournalMediaUpsertGroup`
- **Scope**: `Global`
- **Valid object types**: `JournalPrintMedia`
...
- **Operation**: `newISSN` (AttributeValidatedContextParameterStringBinding) → Attribute: `ProductIssn`
- **Operation**: `DIR` (DataIssuesContextBind)
- **Operation**: `LOG` (LoggerBindContract)
- **Operation**: `ISSNUPDATERULE` (BusinessActionBindContract)
...
- **Source file**: `JournalMediaGroup/JournalMediaUpsertGroup/UpdatePrintISSNKey.js`
