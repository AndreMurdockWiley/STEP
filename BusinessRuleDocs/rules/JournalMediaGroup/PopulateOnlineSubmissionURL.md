# Functional Description: Populate Online Submission URL

## Overview
This document describes the STIBO STEP business rule implemented in `JournalMediaGroup/JournalMediaWorkflowGroup/PopulateOnlineSubmissionURL.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `PopulateOnlineSubmissionURL`
...
- `JournalEditorialSubmissionSystem`
- `JournalGroupCode`
- `JournalREXSiteName`
- `JournalSubmissionUrlValue`
- `PrevSubmissionSys_PIM`
...
- **Source file**: `JournalMediaGroup/JournalMediaWorkflowGroup/PopulateOnlineSubmissionURL.js`
