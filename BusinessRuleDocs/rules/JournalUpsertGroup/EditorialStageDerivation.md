# Functional Description: Editorial Stage Derivation

## Overview
This document describes the STIBO STEP business rule implemented in `JournalUpsertGroup/EditorialStageDerivation.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `EditorialStageDerivation`
- **Rule type**: `BusinessAction`
- **Setup group(s)**: `JournalUpsertGroup`
- **Scope**: `Global`
- **Valid object types**: `JournalPrintMedia`, `Journal`, `JournalDigitalMedia`
...
- **Operation**: `editorialStageLov` (ListOfValuesBindContract)
- **Operation**: `acceptingSubLov` (ListOfValuesBindContract)

### Attributes Referenced (getValue)
- `JournalAcceptingSubmission`
- `JournalEditorialStage`
- `JournalMediaCode`
- `ProductMediaType`
- `ProductStatus`
...
- **Source file**: `JournalUpsertGroup/EditorialStageDerivation.js`
