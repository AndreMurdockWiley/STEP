# Functional Description: Populate Journal Product Identifier

## Overview
This document describes the STIBO STEP business rule implemented in `JournalUpsertGroup/PopulateJournalProductIdentifier.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `PopulateJournalProductIdentifier`
...
- **Source file**: `JournalUpsertGroup/PopulateJournalProductIdentifier.js`
