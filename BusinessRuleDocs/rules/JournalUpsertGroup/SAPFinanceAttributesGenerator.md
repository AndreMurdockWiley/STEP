# Functional Description: SAP Finance Attributes Generator

## Overview
This document describes the STIBO STEP business rule implemented in `JournalUpsertGroup/SAPFinanceAttributesGenerator.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `SAPFinanceAttributesGenerator`
...
- `IssueTemplateMaterialNumber`
- `IssueTemplateTitle`
- `JournalFinanceHigherLevelMediaProduct`
...
- **Source file**: `JournalUpsertGroup/SAPFinanceAttributesGenerator.js`
- **Exports detected**: `operation0`, `operation1`, `operation2`
