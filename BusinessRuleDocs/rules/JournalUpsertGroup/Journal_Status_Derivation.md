# Functional Description: Journal Status Derivation

## Overview
This document describes the STIBO STEP business rule implemented in `JournalUpsertGroup/Journal_Status_Derivation.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `Journal_Status_Derivation`
...
- **Source file**: `JournalUpsertGroup/Journal_Status_Derivation.js`
