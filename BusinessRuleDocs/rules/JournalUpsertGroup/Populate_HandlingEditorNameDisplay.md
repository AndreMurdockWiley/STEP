# Functional Description: Populate Handling Editor Name Display

## Overview
This document describes the STIBO STEP business rule implemented in `JournalUpsertGroup/Populate_HandlingEditorNameDisplay.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `Populate_HandlingEditorNameDisplay`
...
- **Source file**: `JournalUpsertGroup/Populate_HandlingEditorNameDisplay.js`
