# Functional Description: BA_TAEligibility_Derivation

## Overview
This document describes the STIBO STEP business rule implemented in `JournalUpsertGroup/BA_TAEligibility_Derivation.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `BA_TAEligibility_Derivation`
...
- **Source file**: `JournalUpsertGroup/BA_TAEligibility_Derivation.js`
