# Functional Description: BACurrentPortOnTransition

## Overview
This document describes the STIBO STEP business rule implemented in `JournalUpsertGroup/BACurrentPortOnTransition.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `BACurrentPortOnTransition`
...
- **Source file**: `JournalUpsertGroup/BACurrentPortOnTransition.js`
