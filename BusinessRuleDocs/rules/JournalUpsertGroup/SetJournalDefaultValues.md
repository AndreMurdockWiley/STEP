# Functional Description: SetJournalDefaultValues

## Overview
This document describes the STIBO STEP business rule implemented in `JournalUpsertGroup/SetJournalDefaultValues.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `SetJournalDefaultValues`
...
- **Source file**: `JournalUpsertGroup/SetJournalDefaultValues.js`
