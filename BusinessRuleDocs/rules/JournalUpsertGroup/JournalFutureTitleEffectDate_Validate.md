# Functional Description: Journal Future Title Effect Date Validate

## Overview
This document describes the STIBO STEP business rule implemented in `JournalUpsertGroup/JournalFutureTitleEffectDate_Validate.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `JournalFutureTitleEffectDate_Validate`
...
- **Source file**: `JournalUpsertGroup/JournalFutureTitleEffectDate_Validate.js`
