# Functional Description: Mass Populate MM Id

## Overview
This document describes the STIBO STEP business rule implemented in `JournalUpsertGroup/MassPopulateMMId.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
- **Source file**: `JournalUpsertGroup/MassPopulateMMId.js`
