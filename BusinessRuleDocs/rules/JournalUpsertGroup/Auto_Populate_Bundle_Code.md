# Functional Description: Auto Populate Bundle Code

## Overview
This document describes the STIBO STEP business rule implemented in `JournalUpsertGroup/Auto_Populate_Bundle_Code.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `Auto_Populate_Bundle_Code`
...
- **Source file**: `JournalUpsertGroup/Auto_Populate_Bundle_Code.js`
