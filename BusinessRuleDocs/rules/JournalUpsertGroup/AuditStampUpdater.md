# Functional Description: Audit Stamp Updater

## Overview
This document describes the STIBO STEP business rule implemented in `JournalUpsertGroup/AuditStampUpdater.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `AuditStampUpdater`
- **Rule type**: `BusinessAction`
- **Setup group(s)**: `JournalUpsertGroup`
- **Scope**: `Global`
- **Valid object types**: `JournalPrintMedia`, `JournalsProducts`, `Journal`, `JournalDigitalMedia`
...
- **Source file**: `JournalUpsertGroup/AuditStampUpdater.js`
