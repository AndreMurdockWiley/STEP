# Functional Description: Populate PrimaryPortfolio Creation

## Overview
This document describes the STIBO STEP business rule implemented in `JournalUpsertGroup/Populate_PrimaryPortfolio_Creation.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `Populate_PrimaryPortfolio_Creation`
...
- **Source file**: `JournalUpsertGroup/Populate_PrimaryPortfolio_Creation.js`
