# Functional Description: Current Portfolio Derivation

## Overview
This document describes the STIBO STEP business rule implemented in `JournalUpsertGroup/BACurrentPortfolioDerivation.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `BACurrentPortfolioDerivation`
...
- **Operation**: `lth` (LookupTableHomeBindContract)
...
- **Source file**: `JournalUpsertGroup/BACurrentPortfolioDerivation.js`
