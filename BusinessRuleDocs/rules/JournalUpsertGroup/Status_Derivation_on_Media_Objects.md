# Functional Description: Status Derivation on Media Objects

## Overview
This document describes the STIBO STEP business rule implemented in `JournalUpsertGroup/Status_Derivation_on_Media_Objects.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `Status_Derivation_on_Media_Objects`
...
- `DisplayDigitalMediaStatus`
- `DisplayPrintMediaStatus`
...
- **Source file**: `JournalUpsertGroup/Status_Derivation_on_Media_Objects.js`
