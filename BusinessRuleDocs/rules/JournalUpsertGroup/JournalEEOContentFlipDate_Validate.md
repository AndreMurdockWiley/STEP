# Functional Description: JournalEEOContentFlipDate_Validate

## Overview
This document describes the STIBO STEP business rule implemented in `JournalUpsertGroup/JournalEEOContentFlipDate_Validate.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `JournalEEOContentFlipDate_Validate`
...
- **Source file**: `JournalUpsertGroup/JournalEEOContentFlipDate_Validate.js`
