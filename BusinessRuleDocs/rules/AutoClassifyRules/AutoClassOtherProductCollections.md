# Functional Description: Auto Classification Other Product Collection

## Overview
This document describes the STIBO STEP business rule implemented in `AutoClassifyRules/AutoClassOtherProductCollections.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `AutoClassOtherProductCollections`
- **Rule type**: `BusinessAction`
- **Setup group(s)**: `AutoClassifyRules`
- **Scope**: `Global`
...
- **Source file**: `AutoClassifyRules/AutoClassOtherProductCollections.js`
