# Functional Description: Auto Classification Obooks

## Overview
This document describes the STIBO STEP business rule implemented in `AutoClassifyRules/AutoClassificationObooks.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `AutoClassificationObooks`
...
- **Source file**: `AutoClassifyRules/AutoClassificationObooks.js`
