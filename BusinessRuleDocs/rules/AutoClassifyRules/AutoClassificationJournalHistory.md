# Functional Description: Auto Classification Journal History

## Overview
This document describes the STIBO STEP business rule implemented in `AutoClassifyRules/AutoClassificationJournalHistory.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `AutoClassificationJournalHistory`
...
- **Source file**: `AutoClassifyRules/AutoClassificationJournalHistory.js`
