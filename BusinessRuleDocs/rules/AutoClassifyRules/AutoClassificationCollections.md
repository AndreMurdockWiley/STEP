# Functional Description: Auto Classification Collections

## Overview
This document describes the STIBO STEP business rule implemented in `AutoClassifyRules/AutoClassificationCollections.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `AutoClassificationCollections`
- **Rule type**: `BusinessAction`
- **Setup group(s)**: `AutoClassifyRules`
- **Scope**: `Global`
- **Valid object types**: `JournalCollectionsOffering`
...
- **Source file**: `AutoClassifyRules/AutoClassificationCollections.js`
