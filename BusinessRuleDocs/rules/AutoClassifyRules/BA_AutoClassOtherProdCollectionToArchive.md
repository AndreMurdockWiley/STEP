# Functional Description: Auto Classification Other Product Collection To Archive Folder

## Overview
This document describes the STIBO STEP business rule implemented in `AutoClassifyRules/BA_AutoClassOtherProdCollectionToArchive.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `BA_AutoClassOtherProdCollectionToArchive`
...
- **Source file**: `AutoClassifyRules/BA_AutoClassOtherProdCollectionToArchive.js`
