# Functional Description: Auto Classification MultiMedia Packages

## Overview
This document describes the STIBO STEP business rule implemented in `AutoClassifyRules/AutoClassificationMultiMediaPackages.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `AutoClassificationMultiMediaPackages`
- **Rule type**: `BusinessAction`
- **Setup group(s)**: `AutoClassifyRules`
- **Scope**: `Global`
- **Valid object types**: `MultiMedia`
...
- **Source file**: `AutoClassifyRules/AutoClassificationMultiMediaPackages.js`
