# Functional Description: Auto Classification Other Products

## Overview
This document describes the STIBO STEP business rule implemented in `AutoClassifyRules/AutoClassificationOtherProducts.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `AutoClassificationOtherProducts`
...
- **Source file**: `AutoClassifyRules/AutoClassificationOtherProducts.js`
