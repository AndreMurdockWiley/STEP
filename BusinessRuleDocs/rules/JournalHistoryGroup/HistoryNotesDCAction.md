# Functional Description: History Notes Data Container Action

## Overview
This document describes the STIBO STEP business rule implemented in `JournalHistoryGroup/HistoryNotesDCAction.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
- `HistoryNotes`
- `HistoryNotesCreatedBy`
- `HistoryNotesCreatedDate`
- `HistoryNotesIsModified`
- `HistoryNotesModifiedBy`
- `HistoryNotesModifiedDate`
- `HistoryNotesType`
- `JournalNotesHistoryUUID`
...
- **Source file**: `JournalHistoryGroup/HistoryNotesDCAction.js`
