# Functional Description: Journal History ISSN Update

## Overview
This document describes the STIBO STEP business rule implemented in `JournalHistoryGroup/JournalHistoryISSNUpdate.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `JournalHistoryISSNUpdate`
...
- **Source file**: `JournalHistoryGroup/JournalHistoryISSNUpdate.js`
