# Functional Description: Journal History Save Button

## Overview
This document describes the STIBO STEP business rule implemented in `JournalHistoryGroup/JournalHistorySaveButton.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `JournalHistorySaveButton`
...
- **Source file**: `JournalHistoryGroup/JournalHistorySaveButton.js`
