# Functional Description: Volume Functions

## Overview
This document describes the STIBO STEP business rule implemented in `Libraries/VolumeFunctions.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
- **Source file**: `Libraries/VolumeFunctions.js`
- **Exports detected**: `createVolume`, `volumeDeleteCheck`, `deleteVolume`, `volumeCopyToOnline`, `validateIssuesRunDate`
