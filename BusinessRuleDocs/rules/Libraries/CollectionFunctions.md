# Functional Description: Collection Functions

## Overview
This document describes the STIBO STEP business rule implemented in `Libraries/CollectionFunctions.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
- **Source file**: `Libraries/CollectionFunctions.js`
- **Exports detected**: `createCollectionYear`, `createCollectionSubType`, `createCollection`, `generateCommonCollectionAttributes`, `generateTypeSpecificCollectionAttributes`, `generateStandardCollectionAttributes`, `generateUpgradeCollectionAttributes`, `generateSpecificCollectionAttributes`, `collectionTypeConverter`, `copyCollection`, `generateCopiedCollectionAttributes`, `generateStatusSubType`
