# Functional Description: search_object_using_key

## Overview
This document describes the STIBO STEP business rule implemented in `Libraries/search_object_using_key.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `search_object_using_key`
...
- **Source file**: `Libraries/search_object_using_key.js`
