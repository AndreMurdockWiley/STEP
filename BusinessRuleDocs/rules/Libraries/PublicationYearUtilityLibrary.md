# Functional Description: Publication Year Utility Library (OLD)

## Overview
This document describes the STIBO STEP business rule implemented in `Libraries/PublicationYearUtilityLibrary.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `PublicationYearUtilityLibrary`
...
- `JournalGroupCode`
- `JournalMediaCode`
- `JournalNumberOfVolumes`
- `JournalPublicationYear`
- `JournalStartingVolume`
- `NumberOfIssues`
- `ProductPublicationYear`
- `VolumeGroupPublicationSet`
...
- **Source file**: `Libraries/PublicationYearUtilityLibrary.js`
- **Exports detected**: `getJournal`, `getMedia`, `createYear`, `getYearFromMedia`, `createNextYear`, `createVolume`, `getVolumeFromYear`, `createIssue`, `duplicateIssue`, `wipePublishingAttributes`, `copyToOnline`, `copyToOnline2`, `queryForSingleObjByParentAndType`, `queryForObjTypeBelowWithValue`, `copyValue`, `deletePubYear`
