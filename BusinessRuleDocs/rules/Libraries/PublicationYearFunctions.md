# Functional Description: Publication Year Functions

## Overview
This document describes the STIBO STEP business rule implemented in `Libraries/PublicationYearFunctions.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `PublicationYearFunctions`
...
- `volumeFunctions`: `VolumeFunctions`

## Source Implementation
- **Source file**: `Libraries/PublicationYearFunctions.js`
- **Exports detected**: `createYear`, `getNextYear`, `getLastPublicationYear`, `pubYearDeleteCheck`, `deletePubYear`, `yearCopyToOnline`
