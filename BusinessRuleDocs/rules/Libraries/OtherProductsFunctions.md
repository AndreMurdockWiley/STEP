# Functional Description: Other Products Functions

## Overview
This document describes the STIBO STEP business rule implemented in `Libraries/OtherProductsFunctions.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `OtherProductsFunctions`
...
- **Source file**: `Libraries/OtherProductsFunctions.js`
