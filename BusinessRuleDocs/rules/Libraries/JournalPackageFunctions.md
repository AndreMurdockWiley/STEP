# Functional Description: Journal Package Functions

## Overview
This document describes the STIBO STEP business rule implemented in `Libraries/JournalPackageFunctions.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `JournalPackageFunctions`
...
- `MultiJournalPackageSystemMatNo`
...
- **Source file**: `Libraries/JournalPackageFunctions.js`
- **Exports detected**: `sequentialMatNoIncrement`
