# Functional Description: Journal Functions

## Overview
This document describes the STIBO STEP business rule implemented in `Libraries/JournalFunctions.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
- **Source file**: `Libraries/JournalFunctions.js`
- **Exports detected**: `journalCopyToOnlineValidity`
