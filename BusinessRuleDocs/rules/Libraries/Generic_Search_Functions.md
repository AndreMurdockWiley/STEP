# Functional Description: Generic Search Functions

## Overview
This document describes the STIBO STEP business rule implemented in `Libraries/Generic_Search_Functions.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `Generic_Search_Functions`
...
- **Source file**: `Libraries/Generic_Search_Functions.js`
- **Exports detected**: `search_object_using_key`
