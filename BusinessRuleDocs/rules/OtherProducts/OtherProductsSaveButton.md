# Functional Description: Other Products Save Button

## Overview
This document describes the STIBO STEP business rule implemented in `OtherProducts/OtherProductsSaveButton.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `OtherProductsSaveButton`
- **Rule type**: `BusinessAction`
- **Setup group(s)**: `OtherProducts`
- **Scope**: `Global`
- **Valid object types**: `OtherProducts`
...
- **Source file**: `OtherProducts/OtherProductsSaveButton.js`
