# Functional Description: Other Product Initiate Save Button

## Overview
This document describes the STIBO STEP business rule implemented in `OtherProducts/OtherProductsNavegation/OtherProductInitiateSaveButton.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `OtherProductInitiateSaveButton`
- **Rule type**: `BusinessAction`
- **Setup group(s)**: `OtherProductsNavegation`
- **Scope**: `Global`
...
- **Source file**: `OtherProducts/OtherProductsNavegation/OtherProductInitiateSaveButton.js`
