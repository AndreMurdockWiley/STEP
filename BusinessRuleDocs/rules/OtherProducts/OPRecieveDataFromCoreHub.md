...
## Context
- **Rule ID**: `OPRecieveDataFromCoreHub`
- **Rule type**: `BusinessAction`
- **Setup group(s)**: `OtherProductsWorkflowGroup`
- **Scope**: `Global`
...
- **Source file**: `OtherProducts/OtherProductsWorkflowGroup/OPRecieveDataFromCoreHub.js`
