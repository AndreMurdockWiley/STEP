# Functional Description: OP SAP Finance Attributes Generator

## Overview
This document describes the STIBO STEP business rule implemented in `OtherProducts/OtherProductsUpsertGroup/OPSAPFinanceAttributesGenerator.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `OPSAPFinanceAttributesGenerator`
...
- **Source file**: `OtherProducts/OtherProductsUpsertGroup/OPSAPFinanceAttributesGenerator.js`
