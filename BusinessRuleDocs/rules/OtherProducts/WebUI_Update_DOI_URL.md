# Functional Description: WebUI_Update_DOI_URL

## Overview
This document describes the STIBO STEP business rule implemented in `OtherProducts/OtherProductsUpsertGroup/WebUI_Update_DOI_URL.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `WebUI_Update_DOI_URL`
- **Rule type**: `BusinessAction`
- **Setup group(s)**: `OtherProductsUpsertGroup`
- **Scope**: `Global`
...
- **Source file**: `OtherProducts/OtherProductsUpsertGroup/WebUI_Update_DOI_URL.js`
