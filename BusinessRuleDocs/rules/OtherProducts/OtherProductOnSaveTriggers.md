# Functional Description: Other Product On Save Triggers

## Overview
This document describes the STIBO STEP business rule implemented in `OtherProducts/OtherProductsNavegation/OtherProductOnSaveTriggers.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `OtherProductOnSaveTriggers`
...
- **Source file**: `OtherProducts/OtherProductsNavegation/OtherProductOnSaveTriggers.js`
