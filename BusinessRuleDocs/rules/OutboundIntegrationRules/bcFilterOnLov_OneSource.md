# Functional Description: bcFilterOnLov_OneSource

## Overview
This document describes the STIBO STEP business rule implemented in `OutboundIntegrationRules/bcFilterOnLov_OneSource.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `bcFilterOnLov_OneSource`
- **Rule type**: `BusinessCondition`
- **Setup group(s)**: `Outbound_Integration_Rules`
- **Scope**: `Global`
- **Valid object types**: `Domain user-type root`
...
## Inputs
### Bound Inputs (Binds)
- **Operation**: `currentEventType` (CurrentEventTypeBinding)
- **Operation**: `node` (CurrentObjectBindContract)
- **Operation**: `mgr` (ManagerBindContract)
- **Operation**: `LOVID` (ListOfValuesBindContract)
...
- **Source file**: `OutboundIntegrationRules/bcFilterOnLov_OneSource.js`
