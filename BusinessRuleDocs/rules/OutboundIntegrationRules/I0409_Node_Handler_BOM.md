# Functional Description: I0409_Node_Handler_BOM

## Overview
This document describes the STIBO STEP business rule implemented in `OutboundIntegrationRules/I0409_Node_Handler_BOM.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `I0409_Node_Handler_BOM`
...
- **Source file**: `OutboundIntegrationRules/I0409_Node_Handler_BOM.js`
