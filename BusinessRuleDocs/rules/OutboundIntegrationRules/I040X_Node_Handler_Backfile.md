# Functional Description: I040X Node Handler Backfile

## Overview
This document describes the STIBO STEP business rule implemented in `OutboundIntegrationRules/I040X_Node_Handler_Backfile.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `I040X_Node_Handler_Backfile`
...
## Key Dependencies
- `utilityLib`: `Integrations_Utility_Library`

## Source Implementation
- **Source file**: `OutboundIntegrationRules/I040X_Node_Handler_Backfile.js`
