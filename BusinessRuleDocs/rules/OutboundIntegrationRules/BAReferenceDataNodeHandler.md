# Functional Description: Reference Data Node Handler Json Extract

## Overview
This document describes the STIBO STEP business rule implemented in `OutboundIntegrationRules/BAReferenceDataNodeHandler.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `BAReferenceDataNodeHandler`
- **Rule type**: `BusinessAction`
- **Setup group(s)**: `Outbound_Integration_Rules`
- **Scope**: `Global`
...
## Inputs
### Bound Inputs (Binds)
- **Operation**: `nodeHandlerSource` (OutboundBusinessProcessorNodeHandlerSourceBindContract)
- **Operation**: `nodeHandlerResult` (OutboundBusinessProcessorNodeHandlerResultBindContract)
- **Operation**: `executionReportLogger` (OutboundBusinessProcessorExecutionReportLoggerBindContract)
- **Operation**: `stepManager` (ManagerBindContract)
...
## Key Dependencies
- `utilityLib`: `JSON_Reference_Entity_Classification_lib`

## Source Implementation
- **Source file**: `OutboundIntegrationRules/BAReferenceDataNodeHandler.js`
