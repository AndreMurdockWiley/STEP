# Functional Description: I0401_Node_Handler_Journals

## Overview
This document describes the STIBO STEP business rule implemented in `OutboundIntegrationRules/I0401_Node_Handler.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
- **Source file**: `OutboundIntegrationRules/I0401_Node_Handler.js`
