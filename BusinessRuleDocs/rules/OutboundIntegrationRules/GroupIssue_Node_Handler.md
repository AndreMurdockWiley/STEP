# Functional Description: GroupIssue Node Handler

## Overview
This document describes the STIBO STEP business rule implemented in `OutboundIntegrationRules/GroupIssue_Node_Handler.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `GroupIssue_Node_Handler`
...
- **Source file**: `OutboundIntegrationRules/GroupIssue_Node_Handler.js`
