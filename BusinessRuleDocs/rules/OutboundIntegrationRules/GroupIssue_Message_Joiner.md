# Functional Description: GroupIssue_Message_Joiner

## Overview
This document describes the STIBO STEP business rule implemented in `OutboundIntegrationRules/GroupIssue_Message_Joiner.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `GroupIssue_Message_Joiner`
...
## Inputs
### Bound Inputs (Binds)
- **Operation**: `joinerResult` (OutboundBusinessProcessorJoinerResultBindContract)
- **Operation**: `joinerSource` (OutboundBusinessProcessorJoinerSourceBindContract)
...
- **Source file**: `OutboundIntegrationRules/GroupIssue_Message_Joiner.js`
