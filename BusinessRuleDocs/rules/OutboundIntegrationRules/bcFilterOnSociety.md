# Functional Description: bcFilterOnSociety

## Overview
This document describes the STIBO STEP business rule implemented in `OutboundIntegrationRules/bcFilterOnSociety.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `bcFilterOnSociety`
- **Rule type**: `BusinessCondition`
- **Setup group(s)**: `Outbound_Integration_Rules`
- **Scope**: `Global`
- **Valid object types**: `OrganizationType`, `Organizations`
...
- **Operation**: `SocietyCodeRef` (EntityBindContract)
...
- **Source file**: `OutboundIntegrationRules/bcFilterOnSociety.js`
