# Functional Description: bcFilterOnEditorial

## Overview
This document describes the STIBO STEP business rule implemented in `OutboundIntegrationRules/bcFilterOnEditorial.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
- **Operation**: `EditorialCodeRef` (EntityBindContract)

### Attributes Referenced (getValue)
- `EditorialContactEmail`
- `EditorialContactFirstName`
- `EditorialContactLastName`
...
- **Source file**: `OutboundIntegrationRules/bcFilterOnEditorial.js`
