# Functional Description: Journals Completed Transition

## Overview
This document describes the STIBO STEP business rule implemented in `JournalWorkflowGroup/Journals_Completed_Transition.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `Journals_Completed_Transition`
...
- **Source file**: `JournalWorkflowGroup/Journals_Completed_Transition.js`
