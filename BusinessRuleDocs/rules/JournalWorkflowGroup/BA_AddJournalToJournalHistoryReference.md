# Functional Description: Add Journal to Journal History Reference

## Overview
This document describes the STIBO STEP business rule implemented in `JournalWorkflowGroup/BA_AddJournalToJournalHistoryReference.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `BA_AddJournalToJournalHistoryReference`
...
- **Source file**: `JournalWorkflowGroup/BA_AddJournalToJournalHistoryReference.js`
