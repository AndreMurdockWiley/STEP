# Functional Description: Journal WF Save Button

## Overview
This document describes the STIBO STEP business rule implemented in `JournalWorkflowGroup/Journal_WF_Save_Button.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `Journal_WF_Save_Button`
...
- **Source file**: `JournalWorkflowGroup/Journal_WF_Save_Button.js`
