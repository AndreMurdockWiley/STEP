# Functional Description: Set Default Publishing Initiatives

## Overview
This document describes the STIBO STEP business rule implemented in `JournalWorkflowGroup/SetDefaultPublishingInitiatives.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `SetDefaultPublishingInitiatives`
...
- `JournalEditorialDataPolicy`
- `JournalEditorialORCIdRequirement`
- `JournalWileyEditingServices`
...
- **Source file**: `JournalWorkflowGroup/SetDefaultPublishingInitiatives.js`
