# Functional Description: Polulate Journal Maturity

## Overview
This document describes the STIBO STEP business rule implemented in `JournalWorkflowGroup/Polulate_Journal Maturity.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `Polulate_Journal Maturity`
...
- **Source file**: `JournalWorkflowGroup/Polulate_Journal Maturity.js`
