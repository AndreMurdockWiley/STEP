# Functional Description: Journals Completed Transition(2)

## Overview
This document describes the STIBO STEP business rule implemented in `JournalWorkflowGroup/Journals_Completed_Transition_2.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `Journals_Completed_Transition_2`
- **Rule type**: `BusinessAction`
- **Setup group(s)**: `JournalWorkflowGroup`
- **Scope**: `Global`
...
## Components
### Plugin Definitions
- Operation (ReferenceOtherBABusinessAction)
- Operation (ReferenceOtherBABusinessAction)
- Operation (ReferenceOtherBABusinessAction)
- Operation (ReferenceOtherBABusinessAction)
- Operation (ReferenceOtherBABusinessAction)
- Operation (ReferenceOtherBABusinessAction)
- Operation (RemoveObjectFromWorkflowAction)
...
- **Source file**: `JournalWorkflowGroup/Journals_Completed_Transition_2.js`
- **Exports detected**: _None detected_
