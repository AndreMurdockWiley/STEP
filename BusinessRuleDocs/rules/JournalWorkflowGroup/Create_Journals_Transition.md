# Functional Description: Create Journals Transition

## Overview
This document describes the STIBO STEP business rule implemented in `JournalWorkflowGroup/Create_Journals_Transition.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `Create_Journals_Transition`
...
- Operation (ReferenceOtherBABusinessAction)
- Operation (SetAttributeValueBusinessAction)
- Operation (SetAttributeValueBusinessAction)
- Operation (SetAttributeValueBusinessAction)
- Operation (ReferenceOtherBABusinessAction)
- Operation (SetAttributeValueBusinessAction)
...
- **Source file**: `JournalWorkflowGroup/Create_Journals_Transition.js`
