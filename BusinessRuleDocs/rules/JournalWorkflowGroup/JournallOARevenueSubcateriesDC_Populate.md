# Functional Description: Populate OA Revenue Subcategories DC

## Overview
This document describes the STIBO STEP business rule implemented in `JournalWorkflowGroup/JournallOARevenueSubcateriesDC_Populate.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `JournallOARevenueSubcateriesDC_Populate`
...
- `JournalOASubcategories`
- `JournalOASubcategoriesEndDate`
- `JournalOASubcategoriesStartDate`
...
- **Source file**: `JournalWorkflowGroup/JournallOARevenueSubcateriesDC_Populate.js`
