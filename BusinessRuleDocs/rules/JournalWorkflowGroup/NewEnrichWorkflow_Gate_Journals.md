# Functional Description: NewEnrichWorkflow_Gate_Journals

## Overview
This document describes the STIBO STEP business rule implemented in `JournalWorkflowGroup/NewEnrichWorkflow_Gate_Journals.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `NewEnrichWorkflow_Gate_Journals`
...
## Components
### Plugin Definitions
- Operation (BulkUpdateTriggerStateFlowEvent)
...
- **Source file**: `JournalWorkflowGroup/NewEnrichWorkflow_Gate_Journals.js`
