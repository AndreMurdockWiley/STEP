# Functional Description: Journal Notes Data Container Action

## Overview
This document describes the STIBO STEP business rule implemented in `JournalWorkflowGroup/JournalNotesDCAction.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
- `JournalNotes`
- `JournalNotesCreatedBy`
- `JournalNotesCreatedDate`
- `JournalNotesIsModified`
- `JournalNotesJournalUUID`
- `JournalNotesModifiedBy`
- `JournalNotesModifiedDate`
- `JournalNotesSendToSAP`
- `JournalNotesType`
- `JournalSAPNotes`
...
- **Source file**: `JournalWorkflowGroup/JournalNotesDCAction.js`
