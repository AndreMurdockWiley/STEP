# Functional Description: Create Journal History and Reference

## Overview
This document describes the STIBO STEP business rule implemented in `JournalWorkflowGroup/BA_CreateJournalHistoryAndReference.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `BA_CreateJournalHistoryAndReference`
...
- **Source file**: `JournalWorkflowGroup/BA_CreateJournalHistoryAndReference.js`
