# Functional Description: ResendJournalFromSearch

## Overview
This document describes the STIBO STEP business rule implemented in `JournalWorkflowGroup/SendJournal.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
- **Operation**: `JournalRepublish` (EventQueueBinding)
- **Operation**: `JournalRepublishEmail` (EventQueueBinding)
- **Operation**: `JournalRepublishCompact` (EventQueueBinding)
...
- **Source file**: `JournalWorkflowGroup/SendJournal.js`
