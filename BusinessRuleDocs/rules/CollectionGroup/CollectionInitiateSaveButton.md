# Functional Description: Collection Initiate Save Button

## Overview
This document describes the STIBO STEP business rule implemented in `CollectionGroup/CollectionInitiateSaveButton.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `CollectionInitiateSaveButton`
- **Rule type**: `BusinessAction`
- **Setup group(s)**: `CollectionNavegationGroup`
- **Scope**: `Global`
...
- **Source file**: `CollectionGroup/CollectionInitiateSaveButton.js`
