# Functional Description: Collection Content Date Conversion

## Overview
This document describes the STIBO STEP business rule implemented in `CollectionGroup/CollectionContentDateConversion.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `CollectionContentDateConversion`
...
- `JanisComponentContentLicenseStartDate`
...
- **Source file**: `CollectionGroup/CollectionContentDateConversion.js`
