# Functional Description: Collection Upgrade Process

## Overview
This document describes the STIBO STEP business rule implemented in `CollectionGroup/CollectionUpsertGroup/CollectionUpgradeProcess.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `CollectionUpgradeProcess`
...
- **Source file**: `CollectionGroup/CollectionUpsertGroup/CollectionUpgradeProcess.js`
