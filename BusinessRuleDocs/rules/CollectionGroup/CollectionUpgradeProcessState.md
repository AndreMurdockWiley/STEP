# Functional Description: Collection Upgrade Process State

## Overview
This document describes the STIBO STEP business rule implemented in `CollectionGroup/CollectionUpsertGroup/CollectionUpgradeProcessState.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `CollectionUpgradeProcessState`
...
## Components
### Plugin Definitions
- Operation (RepublishEventQueueOperation)
...
- **Source file**: `CollectionGroup/CollectionUpsertGroup/CollectionUpgradeProcessState.js`
