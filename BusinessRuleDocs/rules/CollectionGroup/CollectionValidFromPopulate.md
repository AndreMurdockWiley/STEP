# Functional Description: Collection Valid From Populate

## Overview
This document describes the STIBO STEP business rule implemented in `CollectionGroup/CollectionValidFromPopulate.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `CollectionValidFromPopulate`
- **Rule type**: `BusinessAction`
- **Setup group(s)**: `CollectionsGroup`
- **Scope**: `Global`
- **Valid object types**: `MultiJournal`
...
- **Operation**: `COLLECTIONS_TO_JOURNALS` (ReferenceTypeBindContract)
- **Operation**: `COLLECTION_TO_JOURNALS_ADD` (ReferenceTypeBindContract)
- **Operation**: `COLLECTION_TO_JOURNALS_REMOVE` (ReferenceTypeBindContract)

### Attributes Referenced (getValue)
- `CollectionHeaderContentEndDate`
- `CollectionHeaderContentStartDate`
- `CollectionType`
- `ComponentContentLicenseEndDate`
- `ComponentContentLicenseStartDate`
...
- **Source file**: `CollectionGroup/CollectionValidFromPopulate.js`
