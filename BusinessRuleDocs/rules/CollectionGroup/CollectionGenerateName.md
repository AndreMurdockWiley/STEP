# Functional Description: Collection Generate Name

## Overview
This document describes the STIBO STEP business rule implemented in `CollectionGroup/CollectionUpsertGroup/CollectionGenerateName.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `CollectionGenerateName`
...
- **Source file**: `CollectionGroup/CollectionUpsertGroup/CollectionGenerateName.js`
