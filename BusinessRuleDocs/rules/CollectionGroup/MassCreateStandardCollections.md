# Functional Description: Mass Create Standard Collections

## Overview
This document describes the STIBO STEP business rule implemented in `CollectionGroup/CollectionUpsertGroup/MassCreateStandardCollections.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `MassCreateStandardCollections`
...
- **Source file**: `CollectionGroup/CollectionUpsertGroup/MassCreateStandardCollections.js`
