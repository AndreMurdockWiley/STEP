# Functional Description: Collection Component Update Curr & Future DB Model

## Overview
This document describes the STIBO STEP business rule implemented in `CollectionGroup/CollectionUpsertGroup/CollectionCompsUpdateCurr&FutureDBModel.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `CollectionCompsUpdateCurr&FutureDBModel`
...
- `CollectionCode`
- `CollectionType`
- `JournalInCurrentDatabaseModel`
- `JournalInFutureDatabaseModel`
...
- **Source file**: `CollectionGroup/CollectionUpsertGroup/CollectionCompsUpdateCurr&FutureDBModel.js`
