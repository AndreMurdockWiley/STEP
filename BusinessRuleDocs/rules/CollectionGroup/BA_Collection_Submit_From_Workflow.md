# Functional Description: Collection Submit from Workflow

## Overview
This document describes the STIBO STEP business rule implemented in `CollectionGroup/BA_Collection_Submit_From_Workflow.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `BA_Collection_Submit_From_Workflow`
...
- **Operation**: `collObj` (CurrentObjectBindContract)
- **Operation**: `message` (AttributeValidatedContextParameterStringBinding) → Attribute: `AT_SubmitMessage`
...
- **Source file**: `CollectionGroup/BA_Collection_Submit_From_Workflow.js`
