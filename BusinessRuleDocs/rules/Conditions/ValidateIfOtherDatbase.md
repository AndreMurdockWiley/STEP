# Functional Description: Validate If Other

## Overview
This document describes the STIBO STEP business rule implemented in `Conditions/ValidateIfOtherDatbase.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `ValidateIfOtherDatbase`
...
- **Source file**: `Conditions/ValidateIfOtherDatbase.js`
