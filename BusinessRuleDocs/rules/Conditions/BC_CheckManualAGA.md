# Functional Description: Check Manual AGA

## Overview
This document describes the STIBO STEP business rule implemented in `Conditions/BC_CheckManualAGA.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
- **Source file**: `Conditions/BC_CheckManualAGA.js`
