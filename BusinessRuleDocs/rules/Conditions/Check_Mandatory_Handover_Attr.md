# Functional Description: Check Mandatory Handover Attr

## Overview
This document describes the STIBO STEP business rule implemented in `Conditions/Check_Mandatory_Handover_Attr.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `Check_Mandatory_Handover_Attr`
...
- **Source file**: `Conditions/Check_Mandatory_Handover_Attr.js`
