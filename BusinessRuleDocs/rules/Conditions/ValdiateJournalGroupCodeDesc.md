# Functional Description: Validate If JournalGroupCode Description Missing

## Overview
This document describes the STIBO STEP business rule implemented in `Conditions/ValdiateJournalGroupCodeDesc.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `ValdiateJournalGroupCodeDesc`
- **Rule type**: `BusinessCondition`
- **Setup group(s)**: `Conditions`
- **Scope**: `Global`
- **Valid object types**: `EntityRoot`
...
## Components
### Plugin Definitions
- Operation (JavaScriptBusinessConditionWithBinds)
...
- **Operation**: `JournalGroupCodeDesc` (AttributeBindContract)
- **Operation**: `JournalGroupCodeRef` (EntityBindContract)
- **Operation**: `Manager` (ManagerBindContract)
- **Operation**: `Log` (LoggerBindContract)

### Attributes Referenced (getValue)
- `EntityJournalGroupCodeDescription`
...
- **Source file**: `Conditions/ValdiateJournalGroupCodeDesc.js`
