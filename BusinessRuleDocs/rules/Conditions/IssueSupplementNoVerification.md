# Functional Description: Issue Supplement No Verification

## Overview
This document describes the STIBO STEP business rule implemented in `Conditions/IssueSupplementNoVerification.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `IssueSupplementNoVerification`
...
- **Source file**: `Conditions/IssueSupplementNoVerification.js`
