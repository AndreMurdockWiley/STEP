# Functional Description: Journal On Workflow Check

## Overview
This document describes the STIBO STEP business rule implemented in `Conditions/JournalOnWorkflowCheck.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `JournalOnWorkflowCheck`
...
- **Source file**: `Conditions/JournalOnWorkflowCheck.js`
