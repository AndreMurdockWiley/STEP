# Functional Description: Issue Creation Mandatory Attributes

## Overview
This document describes the STIBO STEP business rule implemented in `Conditions/IssueCreationMandatoryAttributes.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `IssueCreationMandatoryAttributes`
...
- **Operation**: `IssueTypeLOV` (ListOfValuesBindContract)
...
- **Source file**: `Conditions/IssueCreationMandatoryAttributes.js`
