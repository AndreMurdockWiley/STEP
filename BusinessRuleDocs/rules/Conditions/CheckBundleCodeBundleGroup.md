# Functional Description: Check Bundle Code Bundle Group

## Overview
This document describes the STIBO STEP business rule implemented in `Conditions/CheckBundleCodeBundleGroup.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `CheckBundleCodeBundleGroup`
...
- **Source file**: `Conditions/CheckBundleCodeBundleGroup.js`
