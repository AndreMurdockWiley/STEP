# Functional Description: Validate If Product Activated

## Overview
This document describes the STIBO STEP business rule implemented in `Conditions/ValidateIfProductActivated.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `ValidateIfProductActivated`
...
- **Source file**: `Conditions/ValidateIfProductActivated.js`
