# Functional Description: Validate If Static Access Collection

## Overview
This document describes the STIBO STEP business rule implemented in `Conditions/ValidateIfStaticAccCollection.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `ValidateIfStaticAccCollection`
...
- **Source file**: `Conditions/ValidateIfStaticAccCollection.js`
