# Functional Description: Validate If Other Product Special Product

## Overview
This document describes the STIBO STEP business rule implemented in `Conditions/ValidateIfOtherProductSpecialProduct.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `ValidateIfOtherProductSpecialProduct`
...
- **Source file**: `Conditions/ValidateIfOtherProductSpecialProduct.js`
