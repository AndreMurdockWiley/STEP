# Functional Description: Check Subject Ciode Reference

## Overview
This document describes the STIBO STEP business rule implemented in `Conditions/CheckSubjectCiodeReference.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `CheckSubjectCiodeReference`
...
- **Source file**: `Conditions/CheckSubjectCiodeReference.js`
