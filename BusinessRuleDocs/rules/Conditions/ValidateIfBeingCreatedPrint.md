# Functional Description: Validate If Being Created - Print

## Overview
This document describes the STIBO STEP business rule implemented in `Conditions/ValidateIfBeingCreatedPrint.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `ValidateIfBeingCreatedPrint`
...
- **Source file**: `Conditions/ValidateIfBeingCreatedPrint.js`
