# Functional Description: Valid For Copy To Online

## Overview
This document describes the STIBO STEP business rule implemented in `Conditions/ValidForCopyToOnline.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
- **Source file**: `Conditions/ValidForCopyToOnline.js`
