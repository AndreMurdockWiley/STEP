# Functional Description: Validate User Group

## Overview
This document describes the STIBO STEP business rule implemented in `Conditions/ValidateUserGroup.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
- **Source file**: `Conditions/ValidateUserGroup.js`
