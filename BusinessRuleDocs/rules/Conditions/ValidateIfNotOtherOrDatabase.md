# Functional Description: Validate If NOT Other or Database

## Overview
This document describes the STIBO STEP business rule implemented in `Conditions/ValidateIfNotOtherOrDatabase.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `ValidateIfNotOtherOrDatabase`
...
- **Operation**: `COLLECTIONTYPE` (AttributeBindContract)
- **Operation**: `WORKFLOW` (CurrentWorkflowBindContract)
...
- **Source file**: `Conditions/ValidateIfNotOtherOrDatabase.js`
