# Functional Description: BC Validate Text Fields in Mass Update

## Overview
This document describes the STIBO STEP business rule implemented in `Conditions/BC_ValidateTextFieldsMassUploads.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `BC_ValidateTextFieldsMassUploads`
...
- **Operation**: `importChangeInfo` (ImportChangeInfoBind)

### Attributes Referenced (getValue)
- `JournalBackfileContentISSN`
...
- **Source file**: `Conditions/BC_ValidateTextFieldsMassUploads.js`
