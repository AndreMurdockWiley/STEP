# Functional Description: Check Collection Mandatory

## Overview
This document describes the STIBO STEP business rule implemented in `Conditions/CheckCollectionMandatory.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `CheckCollectionMandatory`
...
- **Source file**: `Conditions/CheckCollectionMandatory.js`
