# Functional Description: Return State and Approval

## Overview
This document describes the STIBO STEP business rule implemented in `Conditions/ReturnStateAndApproved.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `ReturnStateAndApproved`
...
- **Source file**: `Conditions/ReturnStateAndApproved.js`
