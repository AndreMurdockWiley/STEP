# Functional Description: Validate If NOT Cochrane Library

## Overview
This document describes the STIBO STEP business rule implemented in `Conditions/ValidateIfNOTCochraneLibrary.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `ValidateIfNOTCochraneLibrary`
...
- **Source file**: `Conditions/ValidateIfNOTCochraneLibrary.js`
