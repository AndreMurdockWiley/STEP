# Functional Description: BC_DisplayHistoryTransition

## Overview
This document describes the STIBO STEP business rule implemented in `Conditions/BC_DisplayHistoryTransition.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `BC_DisplayHistoryTransition`
...
- **Source file**: `Conditions/BC_DisplayHistoryTransition.js`
