# Functional Description: Validate If Other or Database

## Overview
This document describes the STIBO STEP business rule implemented in `Conditions/ValidateIfOtherOrDatabase.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `ValidateIfOtherOrDatabase`
...
- **Source file**: `Conditions/ValidateIfOtherOrDatabase.js`
