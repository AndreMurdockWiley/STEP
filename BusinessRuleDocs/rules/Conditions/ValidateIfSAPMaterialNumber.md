# Functional Description: Validate If SAP Material Number

## Overview
This document describes the STIBO STEP business rule implemented in `Conditions/ValidateIfSAPMaterialNumber.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `ValidateIfSAPMaterialNumber`
...
- **Source file**: `Conditions/ValidateIfSAPMaterialNumber.js`
