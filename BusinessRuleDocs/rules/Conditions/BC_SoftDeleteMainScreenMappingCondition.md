# Functional Description: Soft Delete Main Screen Mapping Condition

## Overview
This document describes the STIBO STEP business rule implemented in `Conditions/BC_SoftDeleteMainScreenMappingCondition.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `BC_SoftDeleteMainScreenMappingCondition`
- **Rule type**: `BusinessCondition`
- **Setup group(s)**: `Conditions`
- **Scope**: `Global`
- **Valid object types**: `JournalHistoryProducts`
...
- **Source file**: `Conditions/BC_SoftDeleteMainScreenMappingCondition.js`
