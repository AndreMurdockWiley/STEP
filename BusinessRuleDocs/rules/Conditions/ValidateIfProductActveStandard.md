# Functional Description: Validate If Product Activated&Standard

## Overview
This document describes the STIBO STEP business rule implemented in `Conditions/ValidateIfProductActveStandard.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `ValidateIfProductActveStandard`
...
- **Source file**: `Conditions/ValidateIfProductActveStandard.js`
