# Functional Description: Validate If Being Created - Online

## Overview
This document describes the STIBO STEP business rule implemented in `Conditions/ValidateIfBeingCreatedOnline.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `ValidateIfBeingCreatedOnline`
...
- **Operation**: `MJMEDIATYPE` (AttributeBindContract)
...
- **Source file**: `Conditions/ValidateIfBeingCreatedOnline.js`
