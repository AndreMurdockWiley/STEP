# Functional Description: Validate If Special Product

## Overview
This document describes the STIBO STEP business rule implemented in `Conditions/ValidateIfSpecialProduct.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `ValidateIfSpecialProduct`
...
- **Source file**: `Conditions/ValidateIfSpecialProduct.js`
