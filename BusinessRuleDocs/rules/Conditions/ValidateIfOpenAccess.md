# Functional Description: Validate If Open Access

## Overview
This document describes the STIBO STEP business rule implemented in `Conditions/ValidateIfOpenAccess.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
- **Source file**: `Conditions/ValidateIfOpenAccess.js`
