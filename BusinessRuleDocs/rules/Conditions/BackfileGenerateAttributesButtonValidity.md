# Functional Description: Backfile Generate Attributes Button Validity

## Overview
This document describes the STIBO STEP business rule implemented in `Conditions/BackfileGenerateAttributesButtonValidity.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `BackfileGenerateAttributesButtonValidity`
...
- **Source file**: `Conditions/BackfileGenerateAttributesButtonValidity.js`
