# Functional Description: Journals Created Transition Condition

## Overview
This document describes the STIBO STEP business rule implemented in `Conditions/JournalsCreatedTransitionCondition.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `JournalsCreatedTransitionCondition`
...
## Components
### Plugin Definitions
- Operation (ReferenceOtherBCBusinessCondition)
- Operation (ReferenceOtherBCBusinessCondition)
...
- **Source file**: `Conditions/JournalsCreatedTransitionCondition.js`
