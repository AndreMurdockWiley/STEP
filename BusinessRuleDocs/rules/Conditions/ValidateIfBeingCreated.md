# Functional Description: Validate If Being Created

## Overview
This document describes the STIBO STEP business rule implemented in `Conditions/ValidateIfBeingCreated.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `ValidateIfBeingCreated`
...
- **Source file**: `Conditions/ValidateIfBeingCreated.js`
