# Functional Description: Validate If Cochrane Library

## Overview
This document describes the STIBO STEP business rule implemented in `Conditions/ValidateIfCochraneLibrary.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `ValidateIfCochraneLibrary`
...
- **Source file**: `Conditions/ValidateIfCochraneLibrary.js`
