# Functional Description: False for Soft Delete

## Overview
This document describes the STIBO STEP business rule implemented in `Conditions/BC_FalseForSoftDelete.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Components
### Plugin Definitions
- Operation (AttributeComparatorCondition)
...
- **Source file**: `Conditions/BC_FalseForSoftDelete.js`
