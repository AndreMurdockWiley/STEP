# Functional Description: Journal ISSN Authentication

## Overview
This document describes the STIBO STEP business rule implemented in `Conditions/JournalIssnAuthentication.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `JournalIssnAuthentication`
...
- **Operation**: `messages` (DataIssuesContextBind)
...
- **Source file**: `Conditions/JournalIssnAuthentication.js`
