# Functional Description: Validate If NOT Cochrane Library - components

## Overview
This document describes the STIBO STEP business rule implemented in `Conditions/ValidateIfNOTCochraneLibraryComponents.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `ValidateIfNOTCochraneLibraryComponents`
...
- **Source file**: `Conditions/ValidateIfNOTCochraneLibraryComponents.js`
