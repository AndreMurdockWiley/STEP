# Functional Description: JSON_Message_Joiner_LZ4

## Overview
This document describes the STIBO STEP business rule implemented in `Integrations/JSON_Message_Joiner_LZ4.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `JSON_Message_Joiner_LZ4`
...
- **Source file**: `Integrations/JSON_Message_Joiner_LZ4.js`
