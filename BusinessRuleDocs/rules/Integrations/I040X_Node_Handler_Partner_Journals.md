# Functional Description: I040X_Node_Handler_Partner_Journals

## Overview
This document describes the STIBO STEP business rule implemented in `Integrations/OutboundIntegrationRules/I040X_Node_Handler_Partner_Journals.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `I040X_Node_Handler_Partner_Journals`
...
- **Source file**: `Integrations/OutboundIntegrationRules/I040X_Node_Handler_Partner_Journals.js`
