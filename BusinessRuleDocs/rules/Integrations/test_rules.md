# Functional Description: Test Rules

## Overview
This document describes the STIBO STEP business rule implemented in `Integrations/test_rules.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
- **Operation**: `qh` (QueryHomeBindContract)
- **Operation**: `journal` (ObjectTypeBindContract)
- **Operation**: `journalPrintVolume` (ObjectTypeBindContract)
- **Operation**: `journalDigitalVolume` (ObjectTypeBindContract)
- **Operation**: `journalPrintIssue` (ObjectTypeBindContract)
- **Operation**: `journalDigitalIssue` (ObjectTypeBindContract)
- **Operation**: `journalProductCode` (AttributeBindContract)
- **Operation**: `journalDigitalMedia` (ObjectTypeBindContract)
- **Operation**: `journalPrintMedia` (ObjectTypeBindContract)
- **Operation**: `issueVolumeNo` (AttributeBindContract)
...
## Key Dependencies
- `genericSearch`: `Generic_Search_Functions`

## Source Implementation
- **Source file**: `Integrations/test_rules.js`
