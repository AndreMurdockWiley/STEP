# Functional Description: SetValueForJournalReconReport

## Overview
This document describes the STIBO STEP business rule implemented in `Integrations/SetValueForJournalReconReport.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `SetValueForJournalReconReport`
- **Rule type**: `BusinessCondition`
- **Setup group(s)**: `OIEP-Filter`
- **Scope**: `Global`
...
- **Source file**: `Integrations/SetValueForJournalReconReport.js`
