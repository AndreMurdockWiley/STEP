# Functional Description: I0401_Node_Handler_JournalNetwork

## Overview
This document describes the STIBO STEP business rule implemented in `Integrations/OutboundIntegrationRules/I0401_Node_Handler_JournalNetwork.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `I0401_Node_Handler_JournalNetwork`
...
- **Operation**: `journalNetworkToJournals` (ReferenceTypeBindContract)
...
## Key Dependencies
- `utilityLib`: `JSON_Util`

## Source Implementation
- **Source file**: `Integrations/OutboundIntegrationRules/I0401_Node_Handler_JournalNetwork.js`
