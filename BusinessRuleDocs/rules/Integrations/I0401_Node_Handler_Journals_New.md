# Functional Description: I0401_Node_Handler_Journals_New

## Overview
This document describes the STIBO STEP business rule implemented in `Integrations/OutboundIntegrationRules/I0401_Node_Handler_Journals_New.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `I0401_Node_Handler_Journals_New`
...
- **Source file**: `Integrations/OutboundIntegrationRules/I0401_Node_Handler_Journals_New.js`
