# Functional Description: Journal Data Extract New

## Overview
This document describes the STIBO STEP business rule implemented in `Integrations/Journal_Data_Extract_New.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `Journal_Data_Extract_New`
...
## Key Dependencies
- `utilityLib`: `JSON_Utility_Library`

## Source Implementation
- **Source file**: `Integrations/Journal_Data_Extract_New.js`
