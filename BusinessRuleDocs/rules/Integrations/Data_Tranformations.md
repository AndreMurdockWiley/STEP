# Functional Description: Data Tranformations

## Overview
This document describes the STIBO STEP business rule implemented in `Integrations/Data_Tranformations.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
- **Operation**: `object` (CurrentObjectBindContract)
- **Operation**: `ipowningcompany` (ListOfValuesBindContract)

### Attributes Referenced (getValue)
- `IP_Owning_SAP_Company`
- `SAP_Plants`
...
- **Source file**: `Integrations/Data_Tranformations.js`
