# Functional Description: BR_I0404

## Overview
This document describes the STIBO STEP business rule implemented in `Integrations/BR_I0404.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
- **Operation**: `manager1` (ManagerBindContract)
...
- `Error_IssueNumber`
- `Error_IssuePubYear`
- `Error_JournalProductCode`
- `Error_JSON_Load`
- `Error_ProductionIdentifier`
- `Error_Timestamp`
- `Error_VolumeNumber`
...
- **Source file**: `Integrations/BR_I0404.js`
