# Functional Description: WALS Journal Data Extract

## Overview
This document describes the STIBO STEP business rule implemented in `Integrations/WALSJournalDataExtract.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `WALSJournalDataExtract`
...
- `JournalWalsParticipation`
- `JournalWalsParticipationStartDate`
- `template_LicenseSubType`
- `template_licenseType`
- `template_name`
- `template_use`
...
- **Source file**: `Integrations/WALSJournalDataExtract.js`
