# Functional Description: Integrations JSON Utility Library

## Overview
This document describes the STIBO STEP business rule implemented in `Integrations/Integrations_Utility_Library.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `Integrations_Utility_Library`
...
- **Source file**: `Integrations/Integrations_Utility_Library.js`
- **Exports detected**: `initialNodeJSON`, `getClassificationRefAsJSON`, `getParentClassificationNodesJSON`, `getReferencesAsJSON`, `retrieveInheritedAttributeLinks`, `addLinkedAttributeIDsToArray`, `addLinkedAttributeIDsToArrayIssues`, `addLinkedAttributeIDsToArrayNONJ`, `addLinkedAttributeIDsToArrayBACKFILE`, `addLinkedAttributeIDsToArrayHistory`, `addLinkedAttributeIDsToArrayMJ`, `addLinkedAttributeIDsToArrayMM`, `addLinkedAttributeIDsToArrayCollections`, `isAttributeValidForRef`, `isAttributeValidForNode`, `getValidAttributes`, `getAllValuesAsJSON`, `getAttributeValue`, `getChildObjects`, `getDataContainers`, `getDataContainerObjects`, `getContainerAttrValues`, `getReferencesToValuesAsJSON`, `getReferencedByToValuesAsJSON`, `getReferencedByToValuesAsJSONCollection`, `getReferencedByToValuesAsJSONHistory`
