# Functional Description: StatusandStatusMessage

## Overview
This document describes the STIBO STEP business rule implemented in `Integrations/StatusandStatusMessage.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `StatusandStatusMessage`
- **Rule type**: `BusinessCondition`
- **Setup group(s)**: `Integrations`
- **Scope**: `Global`
- **Valid object types**: `Backfiles`, `OtherProducts`, `MultiJournal`
...
- **Source file**: `Integrations/StatusandStatusMessage.js`
