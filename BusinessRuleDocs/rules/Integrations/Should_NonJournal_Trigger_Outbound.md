# Functional Description: Should_NonJournal_Trigger_Outbound

## Overview
This document describes the STIBO STEP business rule implemented in `Integrations/Should_NonJournal_Trigger_Outbound.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `Should_NonJournal_Trigger_Outbound`
...
- **Source file**: `Integrations/Should_NonJournal_Trigger_Outbound.js`
