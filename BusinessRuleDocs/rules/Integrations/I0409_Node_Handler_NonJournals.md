# Functional Description: I0409_Node_Handler_NonJournals

## Overview
This document describes the STIBO STEP business rule implemented in `Integrations/OutboundIntegrationRules/I0409_Node_Handler_NonJournals.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `I0409_Node_Handler_NonJournals`
...
- **Source file**: `Integrations/OutboundIntegrationRules/I0409_Node_Handler_NonJournals.js`
