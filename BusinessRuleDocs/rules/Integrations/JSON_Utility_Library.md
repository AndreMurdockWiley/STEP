# Functional Description: JSWA_Utility_Library

## Overview
This document describes the STIBO STEP business rule implemented in `Integrations/JSON_Utility_Library.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
- **Source file**: `Integrations/JSON_Utility_Library.js`
- **Exports detected**: `retrieveInheritedAttributeLinks`, `addLinkedAttributeIDsToArray`, `isAttributeValidForNode`, `getValidAttributes`, `getAttributeValue`, `getAttributeValueID`, `getAllValuesAsJSON`, `getArrayFromMultiValue`
