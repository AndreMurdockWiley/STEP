# Functional Description: JSON_Reference_Entity_Classification_lib

## Overview
This document describes the STIBO STEP business rule implemented in `Integrations/JSON_Reference_Entity_Classification_lib.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `JSON_Reference_Entity_Classification_lib`
...
- **Source file**: `Integrations/JSON_Reference_Entity_Classification_lib.js`
- **Exports detected**: `initialNodeJSON`, `lov`, `getLOVValueIDsfromLOV`, `getClassificationRefAsJSON`, `getParentClassificationNodesJSON`, `getReferencesAsJSON`, `getValidAttributes`, `getAllValuesAsJSON`, `getAttributeValue`, `getChildObjects`, `getDataContainers`, `getDataContainerObjects`, `getContainerAttrValues`, `getContainerAttrValues1`, `getLOVValuesfromLOV`, `getArrayOfLOVValueIDs`
