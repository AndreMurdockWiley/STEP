# Functional Description: Derived Events

## Overview
This document describes the STIBO STEP business rule implemented in `Integrations/DerivedEvents.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
- **Operation**: `currentEventQueue` (CurrentEventQueueBinding)
...
- **Source file**: `Integrations/DerivedEvents.js`
