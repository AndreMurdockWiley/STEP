# Functional Description: Publishing - Volume Creation

## Overview
This document describes the STIBO STEP business rule implemented in `WileyPOCRules/Issue_Creation.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `Issue_Creation`
- **Rule type**: `BusinessAction`
- **Setup group(s)**: `WileyPOCRules`
- **Scope**: `Global`
...
- **Source file**: `WileyPOCRules/Issue_Creation.js`
