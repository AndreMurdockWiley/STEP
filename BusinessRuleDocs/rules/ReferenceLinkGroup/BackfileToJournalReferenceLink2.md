# Functional Description: Backfile To Journal Reference LinkV2

## Overview
This document describes the STIBO STEP business rule implemented in `ReferenceLinkGroup/BackfileToJournalReferenceLink2.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `BackfileToJournalReferenceLink2`
- **Rule type**: `BusinessAction`
- **Setup group(s)**: `ReferenceLinkGroup`
- **Scope**: `Global`
...
- **Operation**: `refType` (ReferenceTypeBindContract)
...
- **Source file**: `ReferenceLinkGroup/BackfileToJournalReferenceLink2.js`
