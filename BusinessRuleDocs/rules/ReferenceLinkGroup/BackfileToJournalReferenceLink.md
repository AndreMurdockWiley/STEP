# Functional Description: Backfile To Journal Reference Link

## Overview
This document describes the STIBO STEP business rule implemented in `ReferenceLinkGroup/BackfileToJournalReferenceLink.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `BackfileToJournalReferenceLink`
...
- **Source file**: `ReferenceLinkGroup/BackfileToJournalReferenceLink.js`
