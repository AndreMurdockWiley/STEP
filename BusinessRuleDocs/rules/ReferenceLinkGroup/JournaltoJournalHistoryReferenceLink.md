# Functional Description: Journal To Journal History Reference Link

## Overview
This document describes the STIBO STEP business rule implemented in `ReferenceLinkGroup/JournaltoJournalHistoryReferenceLink.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `JournaltoJournalHistoryReferenceLink`
...
- **Source file**: `ReferenceLinkGroup/JournaltoJournalHistoryReferenceLink.js`
