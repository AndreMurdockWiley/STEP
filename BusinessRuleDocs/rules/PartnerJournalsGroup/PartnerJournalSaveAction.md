# Functional Description: PartnerJournalSaveAction

## Overview
This document describes the STIBO STEP business rule implemented in `PartnerJournalsGroup/PartnerJournalSaveAction.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `PartnerJournalSaveAction`
- **Rule type**: `BusinessAction`
- **Setup group(s)**: `PartnerJournalsGroup`
- **Scope**: `Global`
- **Valid object types**: `PartnerJournal`
...
- **Source file**: `PartnerJournalsGroup/PartnerJournalSaveAction.js`
