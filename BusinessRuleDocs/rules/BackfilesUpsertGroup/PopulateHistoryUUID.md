# Functional Description: Populate History UUID in Backfile DC

## Overview
This document describes the STIBO STEP business rule implemented in `BackfilesUpsertGroup/PopulateHistoryUUID.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
- **Operation**: `query` (QueryHomeBindContract)

### Attributes Referenced (getValue)
- `BackfileAutopopulateHistoryUUID`
- `BackfileDCHistoryUUID`
- `JournalBackfileContentISSN`
- `JournalBackfileContentJournalGroupCode`
...
- **Source file**: `BackfilesUpsertGroup/PopulateHistoryUUID.js`
