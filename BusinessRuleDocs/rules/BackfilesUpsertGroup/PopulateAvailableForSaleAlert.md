# Functional Description: PopulateAvailableForSaleAlert

## Overview
This document describes the STIBO STEP business rule implemented in `BackfilesUpsertGroup/PopulateAvailableForSaleAlert.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `PopulateAvailableForSaleAlert`
...
- **Source file**: `BackfilesUpsertGroup/PopulateAvailableForSaleAlert.js`
