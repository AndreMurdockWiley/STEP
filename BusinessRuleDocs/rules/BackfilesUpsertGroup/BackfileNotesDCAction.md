# Functional Description: Backfile Notes Data Container Action

## Overview
This document describes the STIBO STEP business rule implemented in `BackfilesUpsertGroup/BackfileNotesDCAction.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
- `BackfileNotes`
- `BackfileNotesCreatedBy`
- `BackfileNotesCreatedDate`
- `BackfileNotesIsModified`
- `BackfileNotesModifiedBy`
- `BackfileNotesModifiedDate`
- `BackfileNotesType`
- `JournalNotesBackfileUUID`
...
- **Source file**: `BackfilesUpsertGroup/BackfileNotesDCAction.js`
