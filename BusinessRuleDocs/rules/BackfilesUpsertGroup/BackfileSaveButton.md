# Functional Description: Backfile Save Button

## Overview
This document describes the STIBO STEP business rule implemented in `BackfilesUpsertGroup/BackfileSaveButton.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
- **Source file**: `BackfilesUpsertGroup/BackfileSaveButton.js`
- **Exports detected**: `operation4`
