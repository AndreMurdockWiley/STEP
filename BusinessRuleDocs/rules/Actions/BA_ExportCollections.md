# Functional Description: BA_ExportCollections

## Overview
This document describes the STIBO STEP business rule implemented in `Actions/BA_ExportCollections.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `BA_ExportCollections`
- **Rule type**: `BusinessAction`
- **Setup group(s)**: `Actions`
- **Scope**: `Global`
- **Valid object types**: `OtherProductCollectionOffering`, `JournalCollectionsOffering`
...
- **Operation**: `mailer` (MailHomeBindContract)
...
- **Source file**: `Actions/BA_ExportCollections.js`
