# Functional Description: BA_triggerOIEPCollReport

## Overview
This document describes the STIBO STEP business rule implemented in `Actions/BA_triggerOIEPCollReport.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `BA_triggerOIEPCollReport`
...
- **Operation**: `collectiontoref` (EventQueueBinding)
- **Operation**: `journalcollection` (EventQueueBinding)
...
- **Source file**: `Actions/BA_triggerOIEPCollReport.js`
