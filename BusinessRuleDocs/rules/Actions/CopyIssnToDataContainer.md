# Functional Description: Copy Issn To Data Container

## Overview
This document describes the STIBO STEP business rule implemented in `Actions/CopyIssnToDataContainer.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `CopyIssnToDataContainer`
...
- **Source file**: `Actions/CopyIssnToDataContainer.js`
