# Functional Description: Export User List

## Overview
This document describes the STIBO STEP business rule implemented in `Actions/BA_ExportUserInventory.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `BA_ExportUserInventory`
...
- **Source file**: `Actions/BA_ExportUserInventory.js`
