# Functional Description: BA_EditorialContactSendOIEP

## Overview
This document describes the STIBO STEP business rule implemented in `Actions/BA_EditorialContactSendOIEP.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `BA_EditorialContactSendOIEP`
...
- Precondition (ReferenceOtherBCBusinessCondition)
...
- **Operation**: `refDataOIEP` (EventQueueBinding)
- **Operation**: `web` (WebUiContextBind)
- **Operation**: `refDataEmailOIEP` (EventQueueBinding)
...
- **Source file**: `Actions/BA_EditorialContactSendOIEP.js`
