# Functional Description: OIEP_Monitoring_2

## Overview
This document describes the STIBO STEP business rule implemented in `Actions/OIEP_Monitoring_2.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
- **Source file**: `Actions/OIEP_Monitoring_2.js`
