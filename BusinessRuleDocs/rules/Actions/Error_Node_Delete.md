# Functional Description: Error_Node_Delete

## Overview
This document describes the STIBO STEP business rule implemented in `Actions/Error_Node_Delete.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `Error_Node_Delete`
- **Rule type**: `BusinessAction`
- **Setup group(s)**: `Actions`
- **Scope**: `Global`
- **Valid object types**: `Error_Record`
...
- **Source file**: `Actions/Error_Node_Delete.js`
