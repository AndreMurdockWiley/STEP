# Functional Description: Remove_DataContainer

## Overview
This document describes the STIBO STEP business rule implemented in `Actions/Remove_DataContainer.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
- **Source file**: `Actions/Remove_DataContainer.js`
