# Functional Description: BA_RemoveLink

## Overview
This document describes the STIBO STEP business rule implemented in `Actions/BA_RemoveLink.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
- **Source file**: `Actions/BA_RemoveLink.js`
