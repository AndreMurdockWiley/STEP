# Functional Description: Backfile Date Conversion

## Overview
This document describes the STIBO STEP business rule implemented in `Actions/Backfile_Date_Conversion.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `Backfile_Date_Conversion`
...
- `JournalBackfileDateWentLive`
- `JournalBackfileLatestPriceDate`
...
- **Source file**: `Actions/Backfile_Date_Conversion.js`
