# Functional Description: Copy ISSN to Data Manual

## Overview
This document describes the STIBO STEP business rule implemented in `Actions/Copy_ISSN_to_Data_Manual.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `Copy_ISSN_to_Data_Manual`
...
- **Source file**: `Actions/Copy_ISSN_to_Data_Manual.js`
