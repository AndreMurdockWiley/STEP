# Functional Description: Workflow_Test_Message

## Overview
This document describes the STIBO STEP business rule implemented in `Actions/Workflow_Test_Message.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
- **Source file**: `Actions/Workflow_Test_Message.js`
