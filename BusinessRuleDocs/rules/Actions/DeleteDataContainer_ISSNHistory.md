# Functional Description: Delete Data Container ISSN History

## Overview
This document describes the STIBO STEP business rule implemented in `Actions/DeleteDataContainer_ISSNHistory.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `DeleteDataContainer_ISSNHistory`
...
- **Source file**: `Actions/DeleteDataContainer_ISSNHistory.js`
