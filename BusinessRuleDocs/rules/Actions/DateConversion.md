# Functional Description: Date Conversion

## Overview
This document describes the STIBO STEP business rule implemented in `Actions/DateConversion.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
- `JournalEditorialAuthorServicesEnabldDt`
- `JournalRightsFromWhatDate`
- `JournalStartDate`
...
- **Source file**: `Actions/DateConversion.js`
