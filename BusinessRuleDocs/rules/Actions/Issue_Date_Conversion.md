# Functional Description: Issue Date Conversion

## Overview
This document describes the STIBO STEP business rule implemented in `Actions/Issue_Date_Conversion.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `Issue_Date_Conversion`
- **Rule type**: `BusinessAction`
- **Setup group(s)**: `ConversionGroup`
- **Scope**: `Global`
...
- **Source file**: `Actions/Issue_Date_Conversion.js`
