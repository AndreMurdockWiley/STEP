# Functional Description: Demo_Class_link

## Overview
This document describes the STIBO STEP business rule implemented in `Actions/Demo_Class_link.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
- **Operation**: `refObj` (ClassificationProductLinkTypeBindContract)
- **Operation**: `stepMan` (ManagerBindContract)
...
- **Source file**: `Actions/Demo_Class_link.js`
