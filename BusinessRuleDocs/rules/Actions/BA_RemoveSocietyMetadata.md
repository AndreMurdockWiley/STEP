# Functional Description: BA_RemoveSocietyMetadata

## Overview
This document describes the STIBO STEP business rule implemented in `Actions/BA_RemoveSocietyMetadata.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `BA_RemoveSocietyMetadata`
- **Rule type**: `BusinessAction`
- **Setup group(s)**: `Actions`
- **Scope**: `Global`
- **Valid object types**: `MultiMedia`, `Journal`, `MultiJournal`
...
- **Operation**: `Journal_Data_Extract_Kafka` (EventQueueBinding)
- **Operation**: `Journal_Data_Extract` (EventQueueBinding)
- **Operation**: `MM_Data_Extract` (EventQueueBinding)
- **Operation**: `MM_Data_Extract_Kafka` (EventQueueBinding)
- **Operation**: `MJ_Data_Extract` (EventQueueBinding)
- **Operation**: `MJ_Data_Extract_Kafka` (EventQueueBinding)

### Attributes Referenced (getValue)
- `JournalSocietyMembershipInfoNoteId`
- `JournalSocietySpecialSensitivitiesId`
...
- **Source file**: `Actions/BA_RemoveSocietyMetadata.js`
