# Functional Description: Change Ref Meta Data Value

## Overview
This document describes the STIBO STEP business rule implemented in `Actions/BA_ChangeRefMetaDataValue.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `BA_ChangeRefMetaDataValue`
...
- **Source file**: `Actions/BA_ChangeRefMetaDataValue.js`
