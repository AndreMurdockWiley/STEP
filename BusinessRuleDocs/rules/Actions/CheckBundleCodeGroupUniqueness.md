# Functional Description: Check Bundle Code Group Uniqueness

## Overview
This document describes the STIBO STEP business rule implemented in `Actions/CheckBundleCodeGroupUniqueness.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `CheckBundleCodeGroupUniqueness`
...
- **Source file**: `Actions/CheckBundleCodeGroupUniqueness.js`
