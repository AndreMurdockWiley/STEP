# Functional Description: Import Issues Manual_V2

## Overview
This document describes the STIBO STEP business rule implemented in `Actions/Import_Issues_Manual_V2.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `Import_Issues_Manual_V2`
...
- **Source file**: `Actions/Import_Issues_Manual_V2.js`
