# Functional Description: Date Conversion Media Import

## Overview
This document describes the STIBO STEP business rule implemented in `Actions/Date_Conversion_Media_Import.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `Date_Conversion_Media_Import`
...
- **Source file**: `Actions/Date_Conversion_Media_Import.js`
