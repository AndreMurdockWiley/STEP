# Functional Description: Delete Data Container Bundle Code

## Overview
This document describes the STIBO STEP business rule implemented in `Actions/DeleteDataContainerBundleCode.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `DeleteDataContainerBundleCode`
...
- **Source file**: `Actions/DeleteDataContainerBundleCode.js`
