# Functional Description: Trigger Editorial Contacts Journals

## Overview
This document describes the STIBO STEP business rule implemented in `Actions/BA_TriggerECJournals.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
- **Source file**: `Actions/BA_TriggerECJournals.js`
