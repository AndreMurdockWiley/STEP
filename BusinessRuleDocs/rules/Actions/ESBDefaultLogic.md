# Functional Description: ESB Default Logic

## Overview
This document describes the STIBO STEP business rule implemented in `Actions/ESBDefaultLogic.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
- **Source file**: `Actions/ESBDefaultLogic.js`
