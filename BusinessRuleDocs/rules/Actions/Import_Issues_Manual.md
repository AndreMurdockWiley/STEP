# Functional Description: Import Issues Manual

## Overview
This document describes the STIBO STEP business rule implemented in `Actions/Import_Issues_Manual.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
- **Source file**: `Actions/Import_Issues_Manual.js`
