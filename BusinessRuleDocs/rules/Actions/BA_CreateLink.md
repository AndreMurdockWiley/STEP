# Functional Description: BA_CreateLink

## Overview
This document describes the STIBO STEP business rule implemented in `Actions/BA_CreateLink.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
- `HistoryTransitionYear`
- `JournalTransitionType`
- `JournalTransitionYear`
...
- **Source file**: `Actions/BA_CreateLink.js`
