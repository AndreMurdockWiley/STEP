# Functional Description: Issue Attributes On-Save Generation

## Overview
This document describes the STIBO STEP business rule implemented in `IssuesGroup/IssuesUpsertGroup/IssueAttributesOnSaveGeneration.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `IssueAttributesOnSaveGeneration`
...
- **Source file**: `IssuesGroup/IssuesUpsertGroup/IssueAttributesOnSaveGeneration.js`
