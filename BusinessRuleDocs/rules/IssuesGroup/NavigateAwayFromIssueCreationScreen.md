# Functional Description: Navigate Away From Issue Creation Screen
...
## Context
- **Rule ID**: `NavigateAwayFromIssueCreationScreen`
...
- **Source file**: `IssuesGroup/IssuesNavegationGroup/NavigateAwayFromIssueCreationScreen.js`
