# Functional Description: Populate Issue Product Identifier

## Overview
This document describes the STIBO STEP business rule implemented in `IssuesGroup/PopulateIssueProductIdentifier.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `PopulateIssueProductIdentifier`
...
- **Source file**: `IssuesGroup/PopulateIssueProductIdentifier.js`
