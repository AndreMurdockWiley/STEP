# Functional Description: Issue Status Mass Update Both

## Overview
This document describes the STIBO STEP business rule implemented in `IssuesGroup/IssuesUpsertGroup/IssueStatusMassUpdateBoth.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `IssueStatusMassUpdateBoth`
...
- **Source file**: `IssuesGroup/IssuesUpsertGroup/IssueStatusMassUpdateBoth.js`
