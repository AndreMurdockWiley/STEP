# Functional Description: ReSend Issues To Sap

## Overview
This document describes the STIBO STEP business rule implemented in `IssuesGroup/IssuesWorkFlowGroup/ReSendIssuesToSap.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `ReSendIssuesToSap`
- **Rule type**: `BusinessAction`
- **Setup group(s)**: `IssuesWorkFlowGroup`
- **Scope**: `Global`
...
## Inputs
### Bound Inputs (Binds)
- **Operation**: `PRODUCTACTIVATED` (AttributeBindContract)
- **Operation**: `UI` (WebUiContextBind)
- **Operation**: `IssueRepublish` (EventQueueBinding)
...
- **Operation**: `IssueRepublishKafka` (EventQueueBinding)
...
- **Source file**: `IssuesGroup/IssuesWorkFlowGroup/ReSendIssuesToSap.js`
