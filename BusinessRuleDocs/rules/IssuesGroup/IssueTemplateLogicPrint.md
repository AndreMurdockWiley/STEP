# Functional Description: Issue Template Logic Print

## Overview
This document describes the STIBO STEP business rule implemented in `IssuesGroup/IssueTemplateLogicPrint.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `IssueTemplateLogicPrint`
...
- `Cross-PlantMaterialStatus`
- `DistributionChannel`
- `ForecastModel`
- `IndustrySector`
- `SchedulingMarginKeyforFloats`
- `TransportationGroup`
...
- **Source file**: `IssuesGroup/IssueTemplateLogicPrint.js`
