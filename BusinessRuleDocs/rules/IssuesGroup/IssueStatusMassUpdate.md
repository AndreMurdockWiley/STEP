# Functional Description: Issue Status Mass Update

## Overview
This document describes the STIBO STEP business rule implemented in `IssuesGroup/IssuesUpsertGroup/IssueStatusMassUpdate.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
- **Operation**: `issueStatusId` (AttributeValidatedContextParameterStringBinding) → Attribute: `IssueStatus`
- **Operation**: `ISSUSTATUS_LOV` (ListOfValuesBindContract)
...
## Key Dependencies
- `link`: `Group Issue Functions`

## Source Implementation
- **Source file**: `IssuesGroup/IssuesUpsertGroup/IssueStatusMassUpdate.js`
