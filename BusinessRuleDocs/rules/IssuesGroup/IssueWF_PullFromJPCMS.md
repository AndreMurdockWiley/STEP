# Functional Description: Issue WF Pull From JPCMS

## Overview
This document describes the STIBO STEP business rule implemented in `IssuesGroup/IssuesWorkFlowGroup/IssueWF_PullFromJPCMS.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
- **Source file**: `IssuesGroup/IssuesWorkFlowGroup/IssueWF_PullFromJPCMS.js`
