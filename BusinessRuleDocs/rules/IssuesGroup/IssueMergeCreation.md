# Functional Description: Issue Merge Creation

## Overview
This document describes the STIBO STEP business rule implemented in `IssuesGroup/IssuesUpsertGroup/IssueMergeCreation.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
- **Source file**: `IssuesGroup/IssuesUpsertGroup/IssueMergeCreation.js`
