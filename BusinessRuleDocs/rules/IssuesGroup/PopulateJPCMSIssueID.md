# Functional Description: PopulateJPCMSIssueID

## Overview
This document describes the STIBO STEP business rule implemented in `IssuesGroup/PopulateJPCMSIssueID.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `PopulateJPCMSIssueID`
- **Rule type**: `BusinessAction`
- **Setup group(s)**: `IssuesGroup`
- **Scope**: `Global`
...
- **Source file**: `IssuesGroup/PopulateJPCMSIssueID.js`
