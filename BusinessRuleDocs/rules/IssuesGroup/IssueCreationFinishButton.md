# Functional Description: Issue Creation/Finish Button

## Overview
This document describes the STIBO STEP business rule implemented in `IssuesGroup/IssuesNavegationGroup/IssueCreationFinishButton.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `IssueCreationFinishButton`
- **Rule type**: `BusinessAction`
- **Setup group(s)**: `IssuesNavegationGroup`
- **Scope**: `Global`
...
- **Source file**: `IssuesGroup/IssuesNavegationGroup/IssueCreationFinishButton.js`
