# Functional Description: Issue Pub Sequence Update

## Overview
This document describes the STIBO STEP business rule implemented in `IssuesGroup/IssuesUpsertGroup/IssuePubSequenceUpdate.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `IssuePubSequenceUpdate`
...
- **Operation**: `pubSequence` (AttributeValidatedContextParameterStringBinding) → Attribute: `IssuePubSequence`
...
- **Source file**: `IssuesGroup/IssuesUpsertGroup/IssuePubSequenceUpdate.js`
