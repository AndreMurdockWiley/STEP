# Functional Description: Update Issue Status

## Overview
This document describes the STIBO STEP business rule implemented in `IssuesGroup/Update_Issue_Status.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
- **Source file**: `IssuesGroup/Update_Issue_Status.js`
