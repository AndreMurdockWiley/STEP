# Functional Description: Issue Merge Creation With Copy To Online

## Overview
This document describes the STIBO STEP business rule implemented in `IssuesGroup/IssuesUpsertGroup/IssueMergeCreationWithCopyToOnline.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `IssueMergeCreationWithCopyToOnline`
...
- **Source file**: `IssuesGroup/IssuesUpsertGroup/IssueMergeCreationWithCopyToOnline.js`
