# Functional Description: Reannounce Pub Year Issues

## Overview
This document describes the STIBO STEP business rule implemented in `ReannouncementGroup/ReannouncePubYearIssues.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `ReannouncePubYearIssues`
...
- **Operation**: `volumeNumber` (AttributeValidatedContextParameterStringBinding) → Attribute: `IssueVolumeNumber`
...
- **Source file**: `ReannouncementGroup/ReannouncePubYearIssues.js`
