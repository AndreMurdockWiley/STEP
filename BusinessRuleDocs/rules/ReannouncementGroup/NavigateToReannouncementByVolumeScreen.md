# Functional Description: Navigate To Reannouncement By Volume Screen

## Overview
This document describes the STIBO STEP business rule implemented in `ReannouncementGroup/NavigateToReannouncementByVolumeScreen.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `NavigateToReannouncementByVolumeScreen`
...
- **Source file**: `ReannouncementGroup/NavigateToReannouncementByVolumeScreen.js`
