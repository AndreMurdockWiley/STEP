# Functional Description: Navigate Away From Pub Reannouncement

## Overview
This document describes the STIBO STEP business rule implemented in `ReannouncementGroup/NavigateAwayFromPubReannouncement.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `NavigateAwayFromPubReannouncement`
...
- **Source file**: `ReannouncementGroup/NavigateAwayFromPubReannouncement.js`
