# Functional Description: Reannounce Pub Year Volumes

## Overview
This document describes the STIBO STEP business rule implemented in `ReannouncementGroup/ReannouncePubYearVolumes.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `ReannouncePubYearVolumes`
- **Rule type**: `BusinessAction`
- **Setup group(s)**: `ReannouncementGroup`
- **Scope**: `Global`
- **Valid object types**: `JournalDigitalVolumes`, `Journal`, `JournalDigitalIssues`
...
- **Operation**: `pubYear` (AttributeValidatedContextParameterStringBinding) → Attribute: `PHPublicationYear`
...
- **Source file**: `ReannouncementGroup/ReannouncePubYearVolumes.js`
