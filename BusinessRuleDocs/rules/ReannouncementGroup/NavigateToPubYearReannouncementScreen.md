# Functional Description: Navigate To Pub Year Reannouncement Screen

## Overview
This document describes the STIBO STEP business rule implemented in `ReannouncementGroup/NavigateToPubYearReannouncementScreen.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `NavigateToPubYearReannouncementScreen`
...
- **Source file**: `ReannouncementGroup/NavigateToPubYearReannouncementScreen.js`
