# Functional Description: Navigate To Reannouncement By Issues Screen

## Overview
This document describes the STIBO STEP business rule implemented in `ReannouncementGroup/NavigateToReannouncementByIssuesScreen.js`. It is generated from the embedded business rule metadata and the JavaScript implementation, following the same overall documentation shape as the Ad Hoc Issue Creation template.
...
## Context
- **Rule ID**: `NavigateToReannouncementByIssuesScreen`
...
- **Source file**: `ReannouncementGroup/NavigateToReannouncementByIssuesScreen.js`
